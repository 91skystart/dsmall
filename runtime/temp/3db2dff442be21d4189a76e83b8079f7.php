<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"/usr/local/var/www/dsmall/public/../application/admin/view/config/base.html";i:1574757822;s:67:"/usr/local/var/www/dsmall/application/admin/view/public/header.html";i:1574757822;s:72:"/usr/local/var/www/dsmall/application/admin/view/public/admin_items.html";i:1574757822;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<div class="page">
    <div class="fixed-bar">
        <div class="item-title">
            <div class="subject">
                <h3><?php echo \think\Lang::get('web_set'); ?></h3>
                <h5></h5>
            </div>
            <?php if($admin_item): ?>
...
<?php endif; ?>
    ...
    <form method="post" enctype="multipart/form-data" name="form1" action="">
        <div class="ncap-form-default">
            ...
            <dl>
                ...
                <dd>
                    ...
                    <span class="type-file-show"><img class="show_image" src="<?php echo ADMIN_SITE_ROOT; ?>/images/preview.png">
                        <div class="type-file-preview"><img src="<?php echo UPLOAD_SITE_URL; ?>/<?php echo ATTACH_COMMON; ?>/<?php echo $list_config['site_logo']; ?>?<?php echo TIMESTAMP; ?>"></div>
                    </span>
                    <?php endif; ?>
                    ...
                    <p class="notic"><?php echo \think\Lang::get('site_logo_notice'); ?></p>
                </dd>
            </dl>
            <dl>
                ...
                <dd>
                    ...
                    <span class="type-file-show"><img class="show_image" src="<?php echo ADMIN_SITE_ROOT; ?>/images/preview.png">
                        <div class="type-file-preview"><img src="<?php echo UPLOAD_SITE_URL; ?>/<?php echo ATTACH_COMMON; ?>/<?php echo $list_config['member_logo']; ?>?<?php echo TIMESTAMP; ?>"></div>
                    </span>
                    <?php endif; ?>
                    ...
                    <p class="notic"><?php echo \think\Lang::get('member_logo_notice'); ?></p>
                </dd>
            </dl>
            <dl>
                ...
                <dd>
                    ...
                    <span class="type-file-show"><img class="show_image" src="<?php echo ADMIN_SITE_ROOT; ?>/images/preview.png">
                        <div class="type-file-preview"><img src="<?php echo UPLOAD_SITE_URL; ?>/<?php echo ATTACH_COMMON; ?>/<?php echo $list_config['seller_center_logo']; ?>?<?php echo TIMESTAMP; ?>"></div>
                    </span>
                    <?php endif; ?>
                    ...
                    <p class="notic"><?php echo \think\Lang::get('seller_center_logo_notice'); ?></p>
                </dd>
            </dl>
            <dl>
                ...
                <dd>
                    ...
                    <span class="type-file-show"><img class="show_image" src="<?php echo ADMIN_SITE_ROOT; ?>/images/preview.png">
                        <div class="type-file-preview"><img src="<?php echo UPLOAD_SITE_URL; ?>/<?php echo ATTACH_COMMON; ?>/<?php echo $list_config['site_mobile_logo']; ?>?<?php echo TIMESTAMP; ?>"></div>
                    </span>
                    <?php endif; ?>
                    ...
                    <p class="notic"><?php echo \think\Lang::get('site_mobile_logo_notice'); ?></p>
                </dd>
            </dl>
            <dl>
                ...
                <dd>
                    ...
                    <span class="type-file-show"><img class="show_image" src="<?php echo ADMIN_SITE_ROOT; ?>/images/preview.png">
                        <div class="type-file-preview"><img src="<?php echo UPLOAD_SITE_URL; ?>/<?php echo ATTACH_COMMON; ?>/<?php echo $list_config['site_logowx']; ?>?<?php echo TIMESTAMP; ?>"></div>
                    </span>
                    <?php endif; ?>
                    ...
                    <p class="notic"><?php echo \think\Lang::get('site_logowx_notice'); ?></p>
                </dd>
            </dl>
            
            <dl id="business_licence" class="noborder">
                    <dt class="required"><label for="file_business_licence"><?php echo \think\Lang::get('config_business_licence'); ?>:</label></dt>
                    <dd class="vatop rowform">
                        ...
                        <span class="type-file-show"><img class="show_image" src="<?php echo ADMIN_SITE_ROOT; ?>/images/preview.png">
                            <div class="type-file-preview"><img src="<?php echo UPLOAD_SITE_URL; ?>/<?php echo ATTACH_COMMON; ?>/<?php echo $list_config['business_licence']; ?>?<?php echo TIMESTAMP; ?>"></div>
                        </span>
                        <?php endif; ?>
            ...
            <dl>
                <dt><?php echo \think\Lang::get('fixed_suspension_state'); ?></dt>
                <dd>
                    <div class="onoff">
                        <label for="fixed_suspension_state1" class="cb-enable <?php if($list_config['fixed_suspension_state'] == 1): ?>selected<?php endif; ?>"><?php echo \think\Lang::get('ds_open'); ?></label>
                        <label for="fixed_suspension_state0" class="cb-disable <?php if($list_config['fixed_suspension_state'] == 0): ?>selected<?php endif; ?>"><?php echo \think\Lang::get('ds_close'); ?></label>
            ...
            <dl id="fixed_suspension_img" class="noborder">
                <dt class="required"><label for="file_fixed_suspension_img"><?php echo \think\Lang::get('fixed_suspension_img'); ?></label></dt>
                <dd class="vatop rowform">
                    ...
                    <span class="type-file-show"><img class="show_image" src="<?php echo ADMIN_SITE_ROOT; ?>/images/preview.png">
                        <div class="type-file-preview"><img src="<?php echo UPLOAD_SITE_URL; ?>/<?php echo ATTACH_COMMON; ?>/<?php echo $list_config['fixed_suspension_img']; ?>?<?php echo TIMESTAMP; ?>"></div>
                    </span>
                    <?php endif; ?>
                    <span class="type-file-box">
                        <input type='text' name='textfield' id='textfield6' class='type-file-text' />
                    ...
                    <p class="notic"><?php echo \think\Lang::get('fixed_suspension_img_notice'); ?></p>
                </dd>
            </dl>
            
              <dl>
                <dt><?php echo \think\Lang::get('fixed_suspension_url'); ?></dt>
                <dd>
                    <input id="fixed_suspension_url" name="fixed_suspension_url" value="<?php echo $list_config['fixed_suspension_url']; ?>" class="input-txt" type="text">
                    <span class="err"></span>
                    <p class="notic"><?php echo \think\Lang::get('fixed_suspension_url_notice'); ?></p>
                </dd>
			</dl>  
              <dl>
            ...
            <dl>
                <dt><?php echo \think\Lang::get('h5_site_url'); ?></dt>
                <dd>
                    <input id="h5_site_url" name="h5_site_url" value="<?php echo $list_config['h5_site_url']; ?>" class="input-txt" type="text">
                    <span class="err"></span>
                    <p class="notic"></p>
                </dd>
            </dl>
            <dl>
                <dt><?php echo \think\Lang::get('h5_force_redirect'); ?></dt>
                <dd>
                    <div class="onoff">
                        <label for="h5_force_redirect1" class="cb-enable <?php if($list_config['h5_force_redirect'] == 1): ?>selected<?php endif; ?>"><?php echo \think\Lang::get('ds_open'); ?></label>
                        <label for="h5_force_redirect0" class="cb-disable <?php if($list_config['h5_force_redirect'] == 0): ?>selected<?php endif; ?>"><?php echo \think\Lang::get('ds_close'); ?></label>
                    ...
                    <p class="notic"><?php echo \think\Lang::get('h5_force_redirect_tips'); ?></p>
                </dd>
            </dl>
            <dl>
                <dt><?php echo \think\Lang::get('baidu_map_ak_key'); ?></dt>
                <dd>
                    <input id="baidu_ak" name="baidu_ak" value="<?php echo $list_config['baidu_ak']; ?>" class="input-txt" type="text">
                    <span class="err"></span>
                    <p class="notic"></p>
                </dd>
            </dl>
            ...
            <dl>
                <dt><?php echo \think\Lang::get('cache_open'); ?></dt>
                <dd>
                    <div class="onoff">
                        <label for="cache_open1" class="cb-enable <?php if($list_config['cache_open'] == 1): ?>selected<?php endif; ?>"><?php echo \think\Lang::get('ds_open'); ?></label>
                        <label for="cache_open0" class="cb-disable <?php if($list_config['cache_open'] == 0): ?>selected<?php endif; ?>"><?php echo \think\Lang::get('ds_close'); ?></label>
            ...
            <dl>
                ...
                <dd>
                    <div class="onoff">
                        <label for="site_state1" class="cb-enable <?php if($list_config['site_state'] == 1): ?>selected<?php endif; ?>"><?php echo \think\Lang::get('ds_open'); ?></label>
                        <label for="site_state0" class="cb-disable <?php if($list_config['site_state'] == 0): ?>selected<?php endif; ?>"><?php echo \think\Lang::get('ds_close'); ?></label>
            ...
            <dl>
                <dt></dt>
                <dd><a href="JavaScript:void(0);" class="btn" onclick="document.form1.submit()"><?php echo \think\Lang::get('ds_confirm_submit'); ?></a></dd>
            </dl>
        </div>
    </form>
