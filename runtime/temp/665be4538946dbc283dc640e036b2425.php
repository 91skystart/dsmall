<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:96:"/usr/local/var/www/dsmall/public/../application/home/view/default/mall/article/article_show.html";i:1574757822;s:75:"/usr/local/var/www/dsmall/application/home/view/default/base/base_home.html";i:1574757822;s:74:"/usr/local/var/www/dsmall/application/home/view/default/base/mall_top.html";i:1574757822;s:77:"/usr/local/var/www/dsmall/application/home/view/default/base/mall_header.html";i:1574757822;s:77:"/usr/local/var/www/dsmall/application/home/view/default/base/mall_server.html";i:1574757822;s:77:"/usr/local/var/www/dsmall/application/home/view/default/base/mall_footer.html";i:1574757822;}*/ ?>
<!doctype html>
<html>
    <head>
...
<div class="w1200">
  ...
  <div class="left">
    <div class="dsh-module dsh-module-style01">
      <div class="title">
        <h3><?php echo \think\Lang::get('article_article_article_class'); ?></h3>
      </div>
      <div class="content">
        <div class="dsh-sidebar-article-class">
          <ul>
            <?php if(is_array($sub_class_list) || $sub_class_list instanceof \think\Collection || $sub_class_list instanceof \think\Paginator): if( count($sub_class_list)==0 ) : echo "" ;else: foreach($sub_class_list as $key=>$v): ?>
            <li><a href="<?php echo url('Article/index',['ac_id'=>$v['ac_id']]); ?>"><?php echo $v['ac_name']; ?></a></li>
            <?php endforeach; endif; else: echo "" ;endif; ?>
          </ul>
        </div>
      </div>
    ...
    <div class="dsh-module dsh-module-style03">
      <div class="title">
        <h3><?php echo \think\Lang::get('article_article_new_article'); ?></h3>
      </div>
      <div class="content">
        <ul class="dsh-sidebar-article-list">
          <?php if(!(empty($new_article_list) || (($new_article_list instanceof \think\Collection || $new_article_list instanceof \think\Paginator ) && $new_article_list->isEmpty()))): if(is_array($new_article_list) || $new_article_list instanceof \think\Collection || $new_article_list instanceof \think\Paginator): if( count($new_article_list)==0 ) : echo "" ;else: foreach($new_article_list as $key=>$v): ?>
          <li><i class="iconfont">&#xe687;</i>
            <a <?php if($v['article_url'] !=""): ?>target="_blank"<?php endif; ?> href="<?php if($v['article_url'] != ''): ?> <?php echo $v['article_url']; else: ?> <?php echo url('Article/show',['article_id'=>$v['article_id']]); endif; ?>">
            <?php echo $v['article_title']; ?>
            </a>
          </li>
         <?php endforeach; endif; else: echo "" ;endif; else: ?>
          <li><?php echo \think\Lang::get('article_article_no_new_article'); ?></li>
         <?php endif; ?>
        </ul>
      </div>
    </div>
  ...
  <div class="right">
    <div class="dsh-article-con">
      ...
      <h2><?php echo date('Y-m-d H:i',$article['article_time']); ?></h2>
      <div class="default">
        <p><?php echo htmlspecialchars_decode($article['article_content']); ?></p>
      </div>
      <div class="more_article">
        <span class="fl"><?php echo \think\Lang::get('article_show_previous'); ?>：
          <?php if(!(empty($pre_article) || (($pre_article instanceof \think\Collection || $pre_article instanceof \think\Paginator ) && $pre_article->isEmpty()))): ?>
        <a <?php if($pre_article['article_url'] !=""): ?>target="_blank"<?php endif; ?> href="<?php if($pre_article['article_url'] !=''): ?><?php echo $pre_article['article_url']; else: ?><?php echo url('Article/show',['article_id'=>$pre_article['article_id']]); endif; ?>">
          <?php echo $pre_article['article_title']; ?>
          </a>
          <time><?php echo date('Y-m-d H:i',$pre_article['article_time']); ?></time>
        <?php else: ?>
        <?php echo \think\Lang::get('article_article_not_found'); endif; ?>
        </span> <span class="fr"><?php echo \think\Lang::get('article_show_next'); ?>：
        ...
        <a <?php if(!(empty($next_article['article_url']) || (($next_article['article_url'] instanceof \think\Collection || $next_article['article_url'] instanceof \think\Paginator ) && $next_article['article_url']->isEmpty()))): ?>target="_blank"<?php endif; ?> href="<?php if(!(empty($next_article['article_url']) || (($next_article['article_url'] instanceof \think\Collection || $next_article['article_url'] instanceof \think\Paginator ) && $next_article['article_url']->isEmpty()))): ?><?php echo $next_article['article_url']; else: ?><?php echo url('Article/show',['article_id'=>$next_article['article_id']]); endif; ?> "><?php echo $next_article['article_title']; ?></a>
        <time><?php echo date('Y-m-d H:i',$next_article['article_time']); ?></time>
        <?php else: ?>
        <?php echo \think\Lang::get('article_article_not_found'); endif; ?>
        </span>
      </div>
...
<div class="server">
    ...
    <div class="mall_desc">
        <?php if(!(empty($article_list) || (($article_list instanceof \think\Collection || $article_list instanceof \think\Paginator ) && $article_list->isEmpty()))): if(is_array($article_list) || $article_list instanceof \think\Collection || $article_list instanceof \think\Paginator): $_5e953468d4047 = is_array($article_list) ? array_slice($article_list,0,4, true) : $article_list->slice(0,4, true); if( count($_5e953468d4047)==0 ) : echo "" ;else: foreach($_5e953468d4047 as $key=>$art): ?>
        <dl> 
