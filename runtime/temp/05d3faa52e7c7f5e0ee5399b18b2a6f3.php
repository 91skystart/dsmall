<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:86:"/usr/local/var/www/dsmall/public/../application/admin/view/goodsclass/goods_class.html";i:1574757822;s:67:"/usr/local/var/www/dsmall/application/admin/view/public/header.html";i:1574757822;s:72:"/usr/local/var/www/dsmall/application/admin/view/public/admin_items.html";i:1574757822;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
    ...
    <table class="ds-default-table">
      ...
      <tbody>
        ...
        <tr class="hover edit" id="ds_row_<?php echo $v['gc_id']; ?>">
          ...
          <td><?php if($v['gc_virtual'] == 1): ?><?php echo \think\Lang::get('ds_virtual'); endif; ?></td>
          <td class="w96">
              ...
              <a href="javascript:dsLayerConfirm('<?php echo url('Goodsclass/goods_class_del',['gc_id'=>$v['gc_id']]); ?>','<?php echo \think\Lang::get('ds_ensure_del'); ?>',<?php echo $v['gc_id']; ?>)"><?php echo \think\Lang::get('ds_del'); ?></a>
          </td>
        </tr>        
