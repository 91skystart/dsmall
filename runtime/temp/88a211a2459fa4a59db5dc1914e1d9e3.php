<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:87:"/usr/local/var/www/dsmall/public/../application/home/view/default/mall/login/login.html";i:1574757822;s:74:"/usr/local/var/www/dsmall/application/home/view/default/base/mall_top.html";i:1574757822;s:77:"/usr/local/var/www/dsmall/application/home/view/default/base/mall_footer.html";i:1574757822;}*/ ?>
<!doctype html>
<html>
    <head>
                    ...
                    <?php if(\think\Config::get('captcha_status_login') == '1'): ?>
                     <div class="item">
                        <div class="text-area">
                            ...
                            <span class="span">
                           <img style="position: absolute;top: 0;height:46px;" src="<?php echo url('Seccode/makecode'); ?>" title="<?php echo \think\Lang::get('login_index_change_checkcode'); ?>" id="codeimage">
...
$(function () {
    ...
    $("#login_normal_form").validate({
        ...
        submitHandler:function(form){
            ds_ajaxpost('login_normal_form','url','<?php if(\think\Request::instance()->param('ref_url')): ?><?php echo \think\Request::instance()->param('ref_url'); else: ?><?php echo url("Member/index"); endif; ?>');
        },
        onkeyup: false,
        rules: {
        ...
        messages: {
            member_name: "<i class='iconfont'>&#xe64c;</i><?php echo \think\Lang::get('please_enter_registered_name'); ?>",
            member_password: "<i class='iconfont'>&#xe64c;</i><?php echo \think\Lang::get('login_index_input_password'); ?>"
            <?php if(\think\Config::get('captcha_status_login') == '1'): ?>,
            captcha_normal: {
                required: '<i class="iconfont" title="<?php echo \think\Lang::get('login_index_input_checkcode'); ?>">&#xe64c;</i><?php echo \think\Lang::get('login_index_input_checkcode'); ?>',
                remote: '<i class="iconfont" title="<?php echo \think\Lang::get('login_index_wrong_checkcode'); ?>">&#xe64c;</i><?php echo \think\Lang::get('login_index_wrong_checkcode'); ?>'
            }
            <?php endif; ?>
        }
    });
...
<script>
            $(function () {
                $("#login_mobile_form").validate({
                    ...
                    submitHandler:function(form){
                        ds_ajaxpost('login_mobile_form','url','<?php if(\think\Request::instance()->param('ref_url')): ?><?php echo \think\Request::instance()->param('ref_url'); else: ?><?php echo url("Member/index"); endif; ?>');
                    },
                    onkeyup: false,
                    rules: {
                        sms_mobile: {
                    ...
                    messages: {
                        sms_mobile: {
                            ...
                            number: '<i class="iconfont">&#xe64c;</i><?php echo \think\Lang::get('login_correct_phone'); ?>',
                            rangelength:'<i class="iconfont">&#xe64c;</i><?php echo \think\Lang::get('login_correct_phone'); ?>'
                        },
                        sms_captcha: {
                            required: '<i class="iconfont">&#xe64c;</i><?php echo \think\Lang::get('login_sms_dynamic_code'); ?>',
                            rangelength: '<i class="iconfont">&#xe64c;</i><?php echo \think\Lang::get('login_sms_dynamic_code'); ?>'
                        }
                        <?php if(\think\Config::get('captcha_status_login') == '1'): ?>,
                        captcha_mobile: {
                            required: '<i class="iconfont">&#xe64c;</i><?php echo \think\Lang::get('login_correct_verification_code'); ?>',
                            minlength: '<i class="iconfont">&#xe64c;</i><?php echo \think\Lang::get('login_correct_verification_code'); ?>',
                            remote: '<i class="iconfont">&#xe64c;</i><?php echo \think\Lang::get('login_correct_verification_code'); ?>'
                        }
                        <?php endif; ?>
                    }
                });
...
<?php endif; if(\think\Config::get('node_site_use') == '1' && !isset($wait) && request()->controller() != 'Payment' && request()->controller() != 'Showgroupbuy'): ?>
