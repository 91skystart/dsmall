...
<div class="alert mt10" style="clear:both;">
    <ul class="mt5">
        <li><?php echo \think\Lang::get('statistical_information1'); ?></li>
        <li><?php echo \think\Lang::get('statistical_information2'); ?></li>
    </ul>
</div>
    ...
    <ul class="mt5">
        <li>
            <span class="w200 fl h30" style="display:block;">
                <i title="<?php echo \think\Lang::get('nearly_orders_money_title'); ?>" class="tip iconfont">&#xe649;</i>
                <?php echo \think\Lang::get('nearly_orders_money'); ?>：<strong><?php echo $statnew_arr['orderamount']; ?><?php echo \think\Lang::get('currency_zh'); ?></strong>
            </span>
            <span class="w200 fl h30" style="display:block;">
                <i title="<?php echo \think\Lang::get('nearly_orders_members_title'); ?>" class="tip iconfont">&#xe649;</i>
                <?php echo \think\Lang::get('nearly_orders_members'); ?>：<strong><?php echo $statnew_arr['ordermembernum']; ?></strong>
            </span>
            <span class="w200 fl h30" style="display:block;">
                <i title="<?php echo \think\Lang::get('nearly_orders_number_title'); ?>" class="tip iconfont">&#xe649;</i>
                <?php echo \think\Lang::get('nearly_orders_number'); ?>：<strong><?php echo $statnew_arr['ordernum']; ?></strong>
            </span>
            <span class="w200 fl h30" style="display:block;">
                <i title="<?php echo \think\Lang::get('nearly_orders_shop_title'); ?>" class="tip iconfont">&#xe649;</i>
                <?php echo \think\Lang::get('nearly_orders_shop'); ?>：<strong><?php echo $statnew_arr['ordergoodsnum']; ?></strong>
            </span>
        </li>
        <li>
            <span class="w200 fl h30" style="display:block;">
                <i title="<?php echo \think\Lang::get('average_guest_price_title'); ?>" class="tip iconfont">&#xe649;</i>
                <?php echo \think\Lang::get('average_guest_price'); ?>：<strong><?php echo $statnew_arr['avgorderamount']; ?><?php echo \think\Lang::get('currency_zh'); ?></strong>
            </span>
            <span class="w200 fl h30" style="display:block;">
                <i title="<?php echo \think\Lang::get('average_price_title'); ?>" class="tip iconfont">&#xe649;</i>
                <?php echo \think\Lang::get('average_price'); ?>：<strong><?php echo $statnew_arr['avggoodsprice']; ?><?php echo \think\Lang::get('currency_zh'); ?></strong>
            </span>
            <span class="w200 fl h30" style="display:block;">
                <i title="<?php echo \think\Lang::get('merchandise_inventory_title'); ?>" class="tip iconfont">&#xe649;</i>
                <?php echo \think\Lang::get('merchandise_inventory'); ?>：<strong><?php echo $statnew_arr['gcollectnum']; ?></strong>
            </span>
            <span class="w200 fl h30" style="display:block;">
                <i title="<?php echo \think\Lang::get('goods_total_number_title'); ?>" class="tip iconfont">&#xe649;</i>
                <?php echo \think\Lang::get('goods_total_number'); ?>：<strong><?php echo $statnew_arr['goodsnum']; ?></strong>
            </span>
        </li>
        <li>
            <span class="w200 fl h30" style="display:block;">
                <i title="<?php echo \think\Lang::get('store_stock_title'); ?>" class="tip iconfont">&#xe649;</i>
                <?php echo \think\Lang::get('store_stock'); ?>：<strong><?php echo $statnew_arr['store_collect']; ?></strong>
            </span>
            <span class="w400 fl h30" style="display:block;">
                <i title="<?php echo \think\Lang::get('order_peak_title'); ?>" class="tip iconfont">&#xe649;</i>
                <?php echo \think\Lang::get('order_peak'); ?>：<strong><?php echo !empty($statnew_arr['hothour'])?$statnew_arr['hothour'] :lang('temporary_no'); ?></strong>
            </span>
        </li>
    </ul>
...
<div class="w450 fl mr50">
    <div class="alert alert-info" style="margin-bottom:0px;"><strong><?php echo \think\Lang::get('recommended_promotion'); ?></strong>
        &nbsp;<i title="<?php echo \think\Lang::get('recommended_promotion_title'); ?>" class="tip iconfont">&#xe649;</i>
    </div>
    <table class="dssc-default-table">
        <thead>
            <tr class="sortbar-array">
                <th class="align-center"><?php echo \think\Lang::get('serial_number'); ?></th>
                <th class="align-center"><?php echo \think\Lang::get('commodity_name'); ?></th>
                <th class="align-center"><?php echo \think\Lang::get('sales'); ?></th>
            </tr>
        </thead>
        <tbody id="datatable">
            ...
            <tr class="bd-line">
                <td class="w50"><?php echo $key+1; ?></td>
                <td class="tl">
                    <span class="over_hidden w340 h20">
                        <a href="<?php echo url('Goods/index',['goods_id'=>$v['goods_id']]); ?>" target="_blank"><?php echo $v['goods_name']; ?></a>
                    </span>
                </td>
            ...
            <tr>
                <td colspan="20" class="norecord">
                    <div class="warning-option">
                        <i class="iconfont">&#xe64c;</i>
                        <span><?php echo \think\Lang::get('no_record'); ?></span>
                    </div>
                </td>
            </tr>
            <?php endif; ?>
...
<div class="w450 fl">
    <div class="alert alert-info" style="margin-bottom:0px;">
        <strong><?php echo \think\Lang::get('peer_selling'); ?></strong>
        &nbsp;<i title="<?php echo \think\Lang::get('peer_selling_title'); ?>" class="tip iconfont">&#xe649;</i>
    </div>
    <table class="dssc-default-table">
        <thead>
            <tr class="sortbar-array">
