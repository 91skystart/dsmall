<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:81:"/usr/local/var/www/dsmall/public/../application/admin/view/member_auth/index.html";i:1574757822;s:67:"/usr/local/var/www/dsmall/application/admin/view/public/header.html";i:1574757822;s:72:"/usr/local/var/www/dsmall/application/admin/view/public/admin_items.html";i:1574757822;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<div class="page">
    <div class="fixed-bar">
        <div class="item-title">
            <div class="subject">
                <h3><?php echo \think\Lang::get('member_auth'); ?></h3>
                <h5></h5>
            </div>
            <?php if($admin_item): ?>
    ...
    <form method="get" name="formSearch" id="formSearch">
        <div class="ds-search-form">
            <dl>
                ...
                <dd>
                    <select name="search_state" >
                        <option value=""><?php echo \think\Lang::get('member_index_state'); ?></option>
                        <option <?php if(\think\Request::instance()->param('search_state') == "check"): ?>selected='selected'<?php endif; ?> value="check"><?php echo \think\Lang::get('member_auth_state')[1]; ?></option>
                        <option <?php if(\think\Request::instance()->param('search_state') == "pass"): ?>selected='selected'<?php endif; ?> value="pass"><?php echo \think\Lang::get('member_auth_state')[3]; ?></option>
                        <option <?php if(\think\Request::instance()->param('search_state') == "fail"): ?>selected='selected'<?php endif; ?> value="fail"><?php echo \think\Lang::get('member_auth_state')[2]; ?></option>
                    </select>
                </dd>
            ...
            <div class="btn_group">
                ...
                <?php if($filtered): ?>
                <a href="<?php echo url('MemberAuth/index'); ?>" class="btn btn-default" title="<?php echo \think\Lang::get('ds_cancel'); ?>"><?php echo \think\Lang::get('ds_cancel'); ?></a>
                <?php endif; ?>
            </div>
        </div>
    </form>
    ...
    <table class="ds-default-table">
      <thead>
        <tr class="thead">
          ...
          <th class="align-center"><?php echo \think\Lang::get('member_index_true_name'); ?></th>
          <th class="align-center"><?php echo \think\Lang::get('member_idcard'); ?></th>
          <th class="align-center"><?php echo \think\Lang::get('member_idcard_image1'); ?></th>
          <th class="align-center"><?php echo \think\Lang::get('member_idcard_image2'); ?></th>
          <th class="align-center"><?php echo \think\Lang::get('member_idcard_image3'); ?></th>
      ...
      <tbody>
        ...
        <tr class="hover member">
          ...
          <td class="align-center"><?php echo $v['member_idcard']; ?></td>
          ...
          <td class="align-center"><?php echo \think\Lang::get('member_auth_state')[$v['member_auth_state']]; ?></td>
          <td class="align-center">
              <?php if($v['member_auth_state'] == 1): ?>
              <a href="javascript:dsLayerConfirm('<?php echo url('MemberAuth/verify',['member_id'=>$v['member_id'],'state'=>1]); ?>','<?php echo \think\Lang::get('ds_ensure_operation'); ?>')" class="dsui-btn-add"><i class="iconfont"></i><?php echo \think\Lang::get('ds_pass'); ?></a>
              <a href="javascript:submit_verify(<?php echo $v['member_id']; ?>,2)" class="dsui-btn-del"><i class="iconfont"></i><?php echo \think\Lang::get('ds_refuse'); ?></a>
              <?php endif; ?>
          </td>
        </tr>
      ...
      <tfoot class="tfoot">
        ...
        <td class="w24"><input type="checkbox" class="checkall" id="checkallBottom"></td>
          ...
          <label for="checkallBottom"><?php echo \think\Lang::get('ds_select_all'); ?></label>
              &nbsp;&nbsp;<a href="JavaScript:void(0);" class="btn btn-small" onclick="submit_verify(0,1)"><span><?php echo \think\Lang::get('ds_pass'); ?></span></a>
              &nbsp;&nbsp;<a href="JavaScript:void(0);" class="btn btn-red btn-small" onclick="submit_verify(0,2)"><span><?php echo \think\Lang::get('ds_refuse'); ?></span></a>    
          </td>
        </tr>
        <?php endif; ?>
      </tfoot>
...
function submit_verify(member_id,state) {
    if(member_id==0){
        ...
        if (items != '') {
            ...
            layer.alert('<?php echo \think\Lang::get('checkbox_empty'); ?>', {icon: 2})  
            return
        }
    }
    if(state==2){
        layer.prompt({title: '<?php echo \think\Lang::get('refuse_reason'); ?>', formType: 2}, function(text, index){
            layer.close(index);
