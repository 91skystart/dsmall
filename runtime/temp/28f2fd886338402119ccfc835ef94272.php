...
<a class="dsm-btn dsm-btn-orange" title="<?php echo \think\Lang::get('predeposit_online_recharge'); ?>" href="<?php echo url('Predeposit/recharge_add'); ?>"> <i class="iconfont">&#xe6f0;</i> <?php echo \think\Lang::get('predeposit_online_recharge'); ?> </a>
...
<div class="alert"><span class="mr30"><?php echo \think\Lang::get('predeposit_pricetype_available'); ?><?php echo \think\Lang::get('ds_colon'); ?><strong class="mr5 red" style="font-size: 18px;"><?php echo $member_info['available_predeposit']; ?></strong><?php echo \think\Lang::get('currency_zh'); ?></span><span><?php echo \think\Lang::get('predeposit_pricetype_freeze'); ?><?php echo \think\Lang::get('ds_colon'); ?><strong class="mr5 blue" style="font-size: 18px;"><?php echo $member_info['freeze_predeposit']; ?></strong><?php echo \think\Lang::get('currency_zh'); ?></span></div>
        <form method="get">
            <table class="dsm-search-table">
                <tr>
                    <td>&nbsp;</td>
                    <th><?php echo \think\Lang::get('predeposit_rechargesn'); ?></th>
                    <td class="w160 tc"><input type="text" class="text w150" name="pdr_sn" value="<?php echo \think\Request::instance()->param('pdr_sn'); ?>"/></td>
                    <td class="w70 tc">
        ...
        <table class="dsm-default-table">
            <thead>
                <tr>
                    <th><?php echo \think\Lang::get('predeposit_rechargesn'); ?></th>
                    <th class="w150"><?php echo \think\Lang::get('predeposit_addtime'); ?></th>
                    <th class="w150"><?php echo \think\Lang::get('predeposit_payment'); ?></th>
                    <th class="w150"><?php echo \think\Lang::get('predeposit_recharge_price'); ?>(<?php echo \think\Lang::get('currency_zh'); ?>)</th>
                    <th class="w150"><?php echo \think\Lang::get('predeposit_paystate'); ?></th>
                    <th class="w110"><?php echo \think\Lang::get('ds_handle'); ?></th>
                </tr>
            </thead>
            <tbody>
                <?php if(!(empty($predeposit_list) || (($predeposit_list instanceof \think\Collection || $predeposit_list instanceof \think\Paginator ) && $predeposit_list->isEmpty()))): if(is_array($predeposit_list) || $predeposit_list instanceof \think\Collection || $predeposit_list instanceof \think\Paginator): if( count($predeposit_list)==0 ) : echo "" ;else: foreach($predeposit_list as $key=>$val): ?>
                <tr class="bd-line">
                    <td><?php echo $val['pdr_sn']; ?></td>
                    <td><?php echo date("Y-m-d H:i:s",$val['pdr_addtime']); ?></td>
                    <td><?php echo get_order_payment_name($val['pdr_payment_code']); ?></td>
                    <td class="red">+<?php echo $val['pdr_amount']; ?></td>
                    <td><?php if(intval($val['pdr_payment_state'])): ?><?php echo \think\Lang::get('predeposit_rechargepaysuccess'); else: ?><?php echo \think\Lang::get('predeposit_rechargewaitpaying'); endif; ?></td>
                    <td class="dsm-table-handle">
                        <?php if(!intval($val['pdr_payment_state'])): ?>
                        <span><a class="btn-green" href="<?php echo url('Buy/pd_pay',['pay_sn'=>$val['pdr_sn']]); ?>"> <i class="iconfont">&#xe6f0;</i>
                                <p><?php echo \think\Lang::get('predeposit_pay'); ?></p>
                            </a></span> <span><a class="btn-red" href="javascript:void(0)" onclick="ds_ajaxget_confirm('<?php echo url('Predeposit/recharge_del',['id'=>$val['pdr_id']]); ?>','<?php echo \think\Lang::get('ds_ensure_del'); ?>');"><i class="iconfont">&#xe725;</i>
                                <p><?php echo \think\Lang::get('ds_del'); ?></p>
                            </a></span>
                        <?php else: ?>
                        <span><a href="<?php echo url('Predeposit/recharge_show',['id'=>$val['pdr_id']]); ?>" class="btn-blue"><i class="iconfont">&#xe70b;</i>
                                <p><?php echo \think\Lang::get('ds_view'); ?></p>
                            </a></span>
                        <?php endif; ?>
                    </td>
                </tr>
            ...
            <tfoot>
                <?php if(!(empty($predeposit_list) || (($predeposit_list instanceof \think\Collection || $predeposit_list instanceof \think\Paginator ) && $predeposit_list->isEmpty()))): ?>
                <tr>
...
<div class="server">
    ...
    <div class="mall_desc">
        <?php if(!(empty($article_list) || (($article_list instanceof \think\Collection || $article_list instanceof \think\Paginator ) && $article_list->isEmpty()))): if(is_array($article_list) || $article_list instanceof \think\Collection || $article_list instanceof \think\Paginator): $_5e9546592673a = is_array($article_list) ? array_slice($article_list,0,4, true) : $article_list->slice(0,4, true); if( count($_5e9546592673a)==0 ) : echo "" ;else: foreach($_5e9546592673a as $key=>$art): ?>
        <dl> 
