<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:84:"/usr/local/var/www/dsmall/public/../application/admin/view/refund/refund_manage.html";i:1574757822;s:67:"/usr/local/var/www/dsmall/application/admin/view/public/header.html";i:1574757822;s:72:"/usr/local/var/www/dsmall/application/admin/view/public/admin_items.html";i:1574757822;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<?php endif; ?>
    ...
    <div class="explanation" id="explanation">
        ...
        <ul>
            <li><?php echo \think\Lang::get('refund_manage_help1'); ?></li>
        </ul>
    </div>
    ...
    <form method="get">
        <div class="ds-search-form">
            ...
            <dl>
                ...
                <dd>
                    <input class="txt date" type="text" value="<?php echo \think\Request::instance()->param('add_time_from'); ?>" id="add_time_from" name="add_time_from">
                    ~ 
                    <input class="txt date" type="text" value="<?php echo \think\Request::instance()->param('add_time_to'); ?>" id="add_time_to" name="add_time_to"/>
                </dd>
            </dl>
            <div class="btn_group">
                <input type="submit" class="btn" value="<?php echo \think\Lang::get('ds_search'); ?>">
                <a href="<?php echo url('Refund/refund_manage'); ?>" class="btn btn-default" title="<?php echo \think\Lang::get('ds_cancel'); ?>"><?php echo \think\Lang::get('ds_cancel'); ?></a>
            </div>
        </div>
    </form>
    ...
    <table class="ds-default-table">
        <thead>
            <tr class="thead">
                ...
                <th><?php echo \think\Lang::get('ds_refund_sn'); ?></th>
                ...
                <th class="align-center"><?php echo \think\Lang::get('refund_seller_time'); ?></th>
        ...
        <tbody>
            ...
            <tr class="bd-line" >
                ...
                <td class="align-center">
                    <a href="javascript:dsLayerOpen('<?php echo url('Refund/edit',['refund_id'=>$val['refund_id']]); ?>','<?php echo \think\Lang::get('refund_order'); ?>-<?php echo $val['order_sn']; ?>')" class="dsui-btn-add"><?php echo \think\Lang::get('refund_confirm'); ?></a>
                </td>
            </tr>
           <?php endforeach; endif; else: echo "" ;endif; ?>
        </tbody>
