<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:80:"/usr/local/var/www/dsmall/public/../application/admin/view/storeclass/index.html";i:1574757822;s:67:"/usr/local/var/www/dsmall/application/admin/view/public/header.html";i:1574757822;s:72:"/usr/local/var/www/dsmall/application/admin/view/public/admin_items.html";i:1574757822;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
  ...
  <div class="explanation" id="explanation">
    ...
    <table class="ds-default-table">
      ...
      <tbody>
        ...
        <tr class="hover edit" id="ds_row_<?php echo $v['storeclass_id']; ?>">
          <td><input type="checkbox" name='check_sc_id[]' value="<?php echo $v['storeclass_id']; ?>" class="checkitem"></td>
          <td class="sort"><span title="<?php echo \think\Lang::get('can_edit'); ?>" ajax_branch='store_class_sort' datatype="number" fieldid="<?php echo $v['storeclass_id']; ?>" fieldname="storeclass_sort" ds_type="inline_edit" class="editable"><?php echo $v['storeclass_sort']; ?></span></td>
          <td class="name">
          	<span title="<?php echo \think\Lang::get('store_class_name'); ?>" required="1" fieldid="<?php echo $v['storeclass_id']; ?>" ajax_branch='store_class_name' fieldname="storeclass_name" ds_type="inline_edit" class="node_name editable"><?php echo $v['storeclass_name']; ?></span>
          </td>
          <td class="align-center"><?php echo $v['storeclass_bail']; ?></td>
          <td>
              <a href="javascript:dsLayerOpen('<?php echo url('Storeclass/store_class_edit',['storeclass_id'=>$v['storeclass_id']]); ?>','<?php echo \think\Lang::get('ds_edit'); ?>-<?php echo $v['storeclass_name']; ?>')" class="dsui-btn-edit"><i class="iconfont"></i><?php echo \think\Lang::get('ds_edit'); ?></a>
              <a href="javascript:dsLayerConfirm('<?php echo url('Storeclass/store_class_del',['storeclass_id'=>$v['storeclass_id']]); ?>','<?php echo \think\Lang::get('del_store_class'); ?>',<?php echo $v['storeclass_id']; ?>)" class="dsui-btn-del"><i class="iconfont"></i><?php echo \think\Lang::get('ds_del'); ?></a>
          </td>
        </tr>
