...
<form method="get" action="<?php echo url('Membervrorder/index'); ?>" target="_self">
    <table class="dsm-search-table">
      <tr>
        <td>&nbsp;</td>
        <th><?php echo \think\Lang::get('member_order_state'); ?></th>
        <td class="w100"><select name="state_type">
            <option value=""><?php echo \think\Lang::get('member_order_all'); ?></option>
            <option value="state_new" <?php if(\think\Request::instance()->param('state_type')=='state_new'): ?>selected<?php endif; ?>><?php echo \think\Lang::get('store_pending_payment'); ?></option>
            <option value="state_pay" <?php if(\think\Request::instance()->param('state_type')=='state_pay'): ?>selected<?php endif; ?>><?php echo \think\Lang::get('store_paid_payment'); ?></option>
            <option value="state_success" <?php if(\think\Request::instance()->param('state_type')=='state_success'): ?>selected<?php endif; ?>><?php echo \think\Lang::get('store_done_payment'); ?></option>
            <option value="state_cancel" <?php if(\think\Request::instance()->param('state_type')=='state_cancel'): ?>selected<?php endif; ?>><?php echo \think\Lang::get('store_cancelled'); ?></option>
          </select></td>
        <th><?php echo \think\Lang::get('member_order_time'); ?></th>
        <td class="w240">
            <input type="text" class="text w70" name="query_start_date" id="query_start_date" value="<?php echo \think\Request::instance()->param('query_start_date'); ?>"/><label class="add-on"><i class="iconfont">&#xe8d6;</i></label>&nbsp;&#8211;&nbsp;
  ...
  <table class="dsm-default-table order">
    <thead>
      <tr>
        ...
        <th class="w100"><?php echo \think\Lang::get('store_order_sell_back'); ?></th>
        <th class="w120"><?php echo \think\Lang::get('store_order_sum'); ?></th>
        <th class="w100"><?php echo \think\Lang::get('store_trading_status'); ?></th>
        <th class="w120"><?php echo \think\Lang::get('store_trading_operations'); ?></th>
      </tr>
    </thead>
    <tbody>
    <?php if(!(empty($order_list) || (($order_list instanceof \think\Collection || $order_list instanceof \think\Paginator ) && $order_list->isEmpty()))): if(is_array($order_list) || $order_list instanceof \think\Collection || $order_list instanceof \think\Paginator): if( count($order_list)==0 ) : echo "" ;else: foreach($order_list as $key=>$order_info): ?>
      <tr>
		<td class="sep-row" colspan="19"></td>
	  </tr>
      <tr>
        <th colspan="20"><span class="ml10"><?php echo \think\Lang::get('store_order_sn'); ?>：<?php echo $order_info['order_sn']; ?>&nbsp;<?php if($order_info['order_from'] == '2'): ?><i class="iconfont">&#xe60e;</i><?php endif; ?></span><span><?php echo \think\Lang::get('store_order_add_time'); ?>：<?php echo date('Y-m-d H:i',$order_info['add_time']); ?></span><span><a
                href="<?php echo url('Store/index',['store_id'=>$order_info['store_id']]); ?>"
          ...
          <span member_id="<?php echo $order_info['extend_store']['member_id']; ?>">
              <?php if(!(empty($order_info['extend_store']['store_qq']) || (($order_info['extend_store']['store_qq'] instanceof \think\Collection || $order_info['extend_store']['store_qq'] instanceof \think\Paginator ) && $order_info['extend_store']['store_qq']->isEmpty()))): ?>
              <a target="_blank" href="<?php echo HTTP_TYPE; ?>wpa.qq.com/msgrd?v=3&uin=<?php echo $order_info['extend_store']['store_qq']; ?>&site=qq&menu=yes" title="QQ: <?php echo $order_info['extend_store']['store_qq']; ?>">
                  <img border="0" src="<?php echo HTTP_TYPE; ?>wpa.qq.com/pa?p=2:<?php echo $order_info['extend_store']['store_qq']; ?>:52" style=" vertical-align: middle;"/></a>
             <?php endif; ?>

              <!-- wang wang -->
              <?php if(!(empty($order_info['extend_store']['store_ww']) || (($order_info['extend_store']['store_ww'] instanceof \think\Collection || $order_info['extend_store']['store_ww'] instanceof \think\Paginator ) && $order_info['extend_store']['store_ww']->isEmpty()))): ?>
              <a target="_blank" href="http://amos.im.alisoft.com/msg.aw?v=2&uid=<?php echo $order_info['extend_store']['store_ww']; ?>&site=cntaobao&s=2" class="vm">
                  <img border="0" src="http://amos.im.alisoft.com/online.aw?v=2&uid=<?php echo $order_info['extend_store']['store_ww']; ?>&site=cntaobao&s=2" alt="Wang Wang" style=" vertical-align: middle;"/></a>
            <?php endif; ?>
          </span>
          </th>
      </tr>
      <tr>
        ...
        <td class="w70"><div class="dsm-goods-thumb">
            <a href="<?php echo url('Goods/index',['goods_id'=>$order_info['goods_id']]); ?>" target="_blank"/><img src="<?php echo goods_thumb($order_info); ?>"/></a></div></td>
        <td class="tl"><dl class="goods-name">
            <dt>
                <a href="<?php echo url('Goods/index',['goods_id'=>$order_info['goods_id']]); ?>" target="_blank" title="<?php echo $order_info['goods_name']; ?>"><?php echo $order_info['goods_name']; ?></a></dt>
            <dd>
                <?php if($order_info['order_promotion_type'] == 1): ?>
                <span class="sale-type"><?php echo \think\Lang::get('store_order_group'); ?></span>
                <?php endif; ?>
                <?php echo \think\Lang::get('store_validity'); ?>：<?php echo date('Y-m-d',$order_info['vr_indate']); ?></dd>
          </dl></td>
        <td><?php echo $order_info['goods_price']; ?></td>
        <td><?php echo $order_info['goods_num']; ?></td>
        <td> 
            <?php if($order_info['if_refund']): ?>
            <a href="<?php echo url('Membervrrefund/add_refund',['order_id'=>$order_info['order_id']]); ?>"><?php echo \think\Lang::get('store_order_refund'); ?></a>
           <?php endif; ?>
        </td>
        <td class="bdl"><strong><?php echo $order_info['order_amount']; ?></strong>
        ...
        <td class="bdl"><p><?php echo $order_info['state_desc']; ?></p>
          <p><a href="<?php echo url('Membervrorder/show_order',['order_id'=>$order_info['order_id']]); ?>"><?php echo \think\Lang::get('store_order_view_order'); ?></a></p></td>
        <td class="bdl bdr">
            <?php if($order_info['if_pay']): ?>
            <p><a class="dsm-btn dsm-btn-orange" href="<?php echo url('Buyvirtual/pay',['order_id'=>$order_info['order_id']]); ?>"><i class="iconfont">&#xe6f0;</i><?php echo \think\Lang::get('store_order_payment'); ?></a></p>
           <?php endif; ?>

            <!--取消订单-->
            <?php if($order_info['if_cancel']): ?>
            <p class="mt5">
                <a href="javascript:void(0)" class="dsm-btn dsm-btn-red" ds_type="dialog" dialog_width="480" dialog_title="<?php echo \think\Lang::get('store_order_cancel_order'); ?>" dialog_id="buyer_order_cancel_order" uri="<?php echo url('Membervrorder/change_state',['state_type'=>'order_cancel','order_id'=>$order_info['order_id']]); ?>" id="order<?php echo $order_info['order_id']; ?>_action_cancel"><i class="iconfont">&#xe754;</i><?php echo \think\Lang::get('store_order_cancel_order'); ?></a></p>
           <?php endif; ?>
            <!-- 评价 -->
            <?php if($order_info['if_evaluation']): ?>
            <p><a class="dsm-btn dsm-btn-acidblue" href="<?php echo url('Memberevaluate/add_vr',['order_id'=>$order_info['order_id']]); ?>"><i class="iconfont">&#xe67e;</i><?php echo \think\Lang::get('member_order_want_evaluate'); ?></a></p>
            <?php endif; if($order_info['evaluation_state'] == '1'): ?><?php echo \think\Lang::get('store_have_evaluation'); endif; ?>
		  </td>
      </tr>
...
<div class="server">
    ...
    <div class="mall_desc">
        <?php if(!(empty($article_list) || (($article_list instanceof \think\Collection || $article_list instanceof \think\Paginator ) && $article_list->isEmpty()))): if(is_array($article_list) || $article_list instanceof \think\Collection || $article_list instanceof \think\Paginator): $_5e952c40d63b4 = is_array($article_list) ? array_slice($article_list,0,4, true) : $article_list->slice(0,4, true); if( count($_5e952c40d63b4)==0 ) : echo "" ;else: foreach($_5e952c40d63b4 as $key=>$art): ?>
        <dl> 
