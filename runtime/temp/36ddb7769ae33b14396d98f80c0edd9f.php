<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:90:"/usr/local/var/www/dsmall/public/../application/home/view/default/mall/login/register.html";i:1574757822;s:74:"/usr/local/var/www/dsmall/application/home/view/default/base/mall_top.html";i:1574757822;s:77:"/usr/local/var/www/dsmall/application/home/view/default/base/mall_footer.html";i:1574757822;}*/ ?>
<!doctype html>
<html>
    <head>
    ...
    <div class="w1200">
        ...
        <form method="post" id="post_form" action="">
            <div class="register_form">
                <div class="mt"><?php echo \think\Lang::get('account_registratio'); ?></div>
                <?php if($member['member_id']): ?>
                <div class="item clearfix">
                    <div class="label"><?php echo \think\Lang::get('recommender'); ?></div>
                    <div class="item-text">
                        <input name='inviter_id' type='hidden' value='<?php echo $member['member_id']; ?>'><span><?php echo $member['member_name']; ?></span>
                    </div>
                </div>
                <?php endif; ?>
                <div class="item clearfix">
                    <div class="label"><?php echo \think\Lang::get('login_register_username'); ?></div>
                    <div class="item-text">
                        <input type="text" id="member_name" name="member_name" class="text" tabindex="1" placeholder="<?php echo \think\Lang::get('login_register_username_to_login'); ?>"/>
                    </div>
                </div>
                <div class="item clearfix">
                    <div class="label">
                        <?php echo \think\Lang::get('login_register_pwd'); ?>
                    </div>
                    <div class="item-text">
                ...
                <div class="item clearfix">
                    <div class="label">
                        <?php echo \think\Lang::get('login_register_ensure_password'); ?>
                    </div>
                    <div class="item-text">
                        <input type="password" id="member_password_confirm" name="member_password_confirm" class="text" tabindex="1" placeholder=""/>
                    </div>
                </div>
                <?php if(\think\Config::get('sms_register') == '1'): ?>
                <div class="item clearfix">
                    <div class="label"><?php echo \think\Lang::get('login_mobile_phone'); ?></div>
                    <div class="item-text">
                        <input type="text" id="sms_mobile" name="sms_mobile" class="text" tabindex="1" placeholder="<?php echo \think\Lang::get('agree_upon_registration'); ?>" maxlength="11"/>
                    </div>
                </div>
                <div class="item clearfix">
                    <div class="label"><?php echo \think\Lang::get('login_mobile_verification_code'); ?></div>
                    <div class="item-text">
                        <input type="text" id="sms_captcha" name="sms_captcha" class="text" tabindex="1" placeholder="<?php echo \think\Lang::get('login_enter_verification_code'); ?>" maxlength="6" style="width:120px;"/>
                        <a class="send_code" id="btn_sms_captcha" ds_type="1"><?php echo \think\Lang::get('login_get_verification_code'); ?></a>
                    </div>
                </div>
                <?php endif; if(\think\Config::get('captcha_status_register') == '1'): ?>
                <div class="item clearfix">
                    <div class="label"><?php echo \think\Lang::get('login_register_code'); ?></div>
                    <div class="item-text">
                        <input type="text" id="captcha_normal" name="captcha_normal" class="text" tabindex="1" placeholder="<?php echo \think\Lang::get('login_register_input_text_in_image'); ?>" maxlength="6" style="width:120px;"/>
                        <span class="span">
                            <img style="position: absolute;top: 0;height:46px;" src="<?php echo url('Seccode/makecode'); ?>" title="<?php echo \think\Lang::get('login_index_change_checkcode'); ?>" id="sms_codeimage" />
                            <a class="makecode" href="javascript:void(0);" onclick="javascript:document.getElementById('sms_codeimage').src='<?php echo url('Seccode/makecode'); ?>'+'?'+(new Date().getTime());;"><?php echo \think\Lang::get('login_password_change_code'); ?></a>
                        </span>
                    </div>
                </div>
                <?php endif; ?>
                <div class="item clearfix">
                    <div class="label">&nbsp;</div>
                    <div class="item-text">
                        <?php echo \think\Lang::get('agree_upon_registration'); ?><a href='<?php echo url("Document/index",["code"=>"agreement"]); ?>' target='_blank'><?php echo \think\Lang::get('user_registration_protocol'); ?></a>
                    </div>
                </div>
                <div class="item">
                    <input type="submit" class="btn login-btn" value=<?php echo \think\Lang::get('login_register_login_now_4'); ?> />
                </div>
            </div>
        </form>
    </div>
...
<script>
    $(function () {
        $("#post_form").validate({
            ...
            messages: {
                member_name: {
                    required: '<i class="iconfont">&#xe64c;</i><?php echo \think\Lang::get('login_register_input_username'); ?>',
                    minlength: '<i class="iconfont">&#xe64c;</i><?php echo \think\Lang::get('login_register_username_range'); ?>',
                    maxlength: '<i class="iconfont">&#xe64c;</i><?php echo \think\Lang::get('login_register_username_range'); ?>',
                    remote: '<i class="iconfont">&#xe64c;</i><?php echo \think\Lang::get('login_register_username_exists'); ?>'
                },
                member_password: {
                    required: '<i class="iconfont">&#xe64c;</i><?php echo \think\Lang::get('login_register_input_password'); ?>',
                    minlength: '<i class="iconfont">&#xe64c;</i><?php echo \think\Lang::get('login_register_password_range'); ?>',
                    maxlength: '<i class="iconfont">&#xe64c;</i><?php echo \think\Lang::get('login_register_password_range'); ?>'
                },
                member_password_confirm: {
                    required: '<i class="iconfont">&#xe64c;</i><?php echo \think\Lang::get('login_register_input_password_again'); ?>',
                    equalTo: '<i class="iconfont">&#xe64c;</i><?php echo \think\Lang::get('login_register_password_not_same'); ?>'
                },
                <?php if(\think\Config::get('sms_register') == '1'): ?>
                sms_mobile: {
                    required: '<i class="iconfont">&#xe64c;</i><?php echo \think\Lang::get('login_correct_phone'); ?>',
                    minlength: '<i class="iconfont">&#xe64c;</i><?php echo \think\Lang::get('login_correct_phone'); ?>',
                    maxlength: '<i class="iconfont">&#xe64c;</i><?php echo \think\Lang::get('login_correct_phone'); ?>'
                },
                sms_captcha: {
                    required: '<i class="iconfont">&#xe64c;</i><?php echo \think\Lang::get('login_sms_dynamic_code'); ?>'
                    minlength: '<i class="iconfont">&#xe64c;</i><?php echo \think\Lang::get('login_sms_dynamic_code'); ?>'
                },
                <?php endif; if(\think\Config::get('captcha_status_register') == '1'): ?>
                captcha_normal: {
                    required: '<i class="iconfont">&#xe64c;</i><?php echo \think\Lang::get('login_index_input_checkcode'); ?>',
                    minlength: '<i class="iconfont">&#xe64c;</i><?php echo \think\Lang::get('login_index_wrong_checkcode'); ?>',
                    remote: '<i class="iconfont">&#xe64c;</i><?php echo \think\Lang::get('login_index_wrong_checkcode'); ?>'
                },
                <?php endif; ?>
            }
        });
