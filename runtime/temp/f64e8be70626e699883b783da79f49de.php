<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:81:"/usr/local/var/www/dsmall/public/../application/admin/view/dashboard/welcome.html";i:1574757822;s:67:"/usr/local/var/www/dsmall/application/admin/view/public/header.html";i:1574757822;s:72:"/usr/local/var/www/dsmall/application/admin/view/public/admin_items.html";i:1574757822;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<?php endif; ?>
    ...
    <div class="title"><?php echo \think\Lang::get('dashboard_base_info'); ?></div>
        ...
        <ul>
            <li>
                <a href="<?php echo url('Member/member'); ?>">
                    ...
                    <div class="p_content">
                        <div class="p_text"><?php echo \think\Lang::get('dashboard_wel_member_des'); ?></div>
            ...
            <li>
                <a href="<?php echo url('Store/store'); ?>">
                    ...
                    <div class="p_content">
                        <div class="p_text"><?php echo \think\Lang::get('dashboard_wel_store_des'); ?></div>
            ...
            <li>
                <a href="<?php echo url('Goods/index'); ?>">
                    ...
                    <div class="p_content">
                        <div class="p_text"><?php echo \think\Lang::get('dashboard_wel_total_goods'); ?></div>
            ...
            <li>
                <a href="<?php echo url('Order/index'); ?>">
                    ...
                    <div class="p_content">
                        <div class="p_text"><?php echo \think\Lang::get('dashboard_wel_trade_des'); ?></div>
            ...
            <li>
                <a href="<?php echo url('Operation/setting'); ?>">
                    ...
                    <div class="p_content">
                        <div class="p_text"><?php echo \think\Lang::get('dashboard_wel_stat_des'); ?></div>
                    </div>
                </a>
            </li>
        </ul>
    </div>
    <div class="title"><?php echo \think\Lang::get('dashboard_weekly_overview'); ?></div>
    <div class="info-chart">
        <div class="week">
            <ul class="tab">
                <li class="active"><?php echo \think\Lang::get('dashboard_member_growth'); ?></li>
                <li><?php echo \think\Lang::get('dashboard_goods_growth'); ?></li>
                <li><?php echo \think\Lang::get('dashboard_store_growth'); ?></li>
                <li><?php echo \think\Lang::get('dashboard_order_growth'); ?></li>
            </ul>
    ...
    <div class="title"><?php echo \think\Lang::get('dashboard_dealt'); ?></div>
    <div class="info-statistical clearfix">
        <!--会员-->
        <div class="info-panel">
            <div class="mt"><?php echo \think\Lang::get('ds_member'); ?></div>
            <div class="mc">
                <ul>
                    <li class="none">
                        <a href="<?php echo url('Member/member'); ?>">
        ...
        <!--店铺-->
        <div class="info-panel">
            <div class="mt"><?php echo \think\Lang::get('ds_store'); ?></div>
            <div class="mc">
                <ul>
                    <li class="none">
        ...
        <!--商品-->
        <div class="info-panel">
            <div class="mt"><?php echo \think\Lang::get('ds_goods'); ?></div>
            <div class="mc">
                <ul>
                    <li class="none">
                        <a href="<?php echo url('Goods/index'); ?>">
        ...
        <!--交易-->
        <div class="info-panel">
            <div class="mt"><?php echo \think\Lang::get('ds_trade'); ?></div>
            <div class="mc">
                <ul>
                    <li class="none">
        ...
        <!--营销-->
        <div class="info-panel">
            <div class="mt"><?php echo \think\Lang::get('ds_operation'); ?></div>
            <div class="mc">
                <ul>
                    <li class="none">
    ...
    <div class="title"><?php echo \think\Lang::get('dashboard_wel_version_info'); ?></div>
    ...
    <div class="title"><?php echo \think\Lang::get('dashboard_wel_sys_info'); ?></div>
    <div class="info-system">
        <table cellpadding="0" cellspacing="0" class="system_table">
            <tbody>
                <tr>
