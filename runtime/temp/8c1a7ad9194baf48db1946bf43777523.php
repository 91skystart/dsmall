<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:84:"/usr/local/var/www/dsmall/public/../application/admin/view/public/dispatch_jump.html";i:1574757822;}*/ ?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title><?php echo \think\Lang::get('jump_message'); ?></title>
    <style type="text/css">
        *{ padding: 0; margin: 0; }
...
<body>
    <div class="system-message">
        <?php switch ($code) {case 1:?>
            <h1><img src="<?php echo ADMIN_SITE_ROOT; ?>/images/dispatch_jump_success.png"/><?php echo \think\Lang::get('ds_common_op_succ'); ?>!</h1>
            <p class="success"><?php echo(strip_tags($msg));?></p>
            <?php break;case 0:?>
            <h1><img src="<?php echo ADMIN_SITE_ROOT; ?>/images/dispatch_jump_error.png"/><?php echo \think\Lang::get('has_error'); ?>!</h1>
            <p class="error"><?php echo(strip_tags($msg));?></p>
            <?php break;} ?>
        <p class="detail"></p>
        <p class="jump"><?php echo \think\Lang::get('page_auto'); ?> <a id="href" href="<?php echo $url; ?>"><?php echo \think\Lang::get('jump'); ?></a> <?php echo \think\Lang::get('wait_time'); ?>： <b id="wait"><?php echo $wait; ?></b></p>
    </div>
