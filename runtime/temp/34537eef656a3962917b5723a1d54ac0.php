    ...
    <thead>
        ...
        <tr>
            ...
            <td colspan="20"><label for="all"><?php echo \think\Lang::get('ds_select_all'); ?></label>
                <a href="javascript:void(0)" class="dssc-btn-mini" ds_type="batchbutton" uri="<?php echo url('Sellergoodsclass/drop_goods_class'); ?>" name="class_id" confirm="<?php echo \think\Lang::get('store_goods_class_ensure_del'); ?>?"><i class="iconfont">&#xe725;</i><?php echo \think\Lang::get('ds_del'); ?></a></td>
        </tr>
        <?php endif; ?>
    </thead>
    <tbody id="treet1">
        ...
        <tr class="bd-line" ds_type="table_item" idvalue="<?php echo $val['storegc_id']; ?>" >
            ...
            <td class="dscs-table-handle"><span><a href="javascript:void(0)" ds_type="dialog" dialog_width="480" dialog_title="<?php echo \think\Lang::get('store_goods_class_edit_class'); ?>" dialog_id="my_category_edit" uri="<?php echo url('Sellergoodsclass/goods_class_edit',['top_class_id'=>$val['storegc_id']]); ?>" class="btn-blue"><i class="iconfont">&#xe731;</i>
                        <p><?php echo \think\Lang::get('ds_edit'); ?></p>
                    </a></span> <span><a href="javascript:void(0)" onclick="ds_ajaxget_confirm('<?php echo url('Sellergoodsclass/drop_goods_class',['class_id'=>$val['storegc_id']]); ?>','<?php echo \think\Lang::get('store_goods_class_ensure_del'); ?>?');" class="btn-red"><i class="iconfont">&#xe725;</i>
    ...
    <tfoot>
        <tr>
            ...
            <th colspan="15"><label for="all2"><?php echo \think\Lang::get('ds_select_all'); ?></label>
                <a href="javascript:void(0)" class="dssc-btn-mini" ds_type="batchbutton" uri="<?php echo url('Sellergoodsclass/drop_goods_class'); ?>" name="class_id" confirm="<?php echo \think\Lang::get('store_goods_class_ensure_del'); ?>?"><i class="iconfont">&#xe725;</i><?php echo \think\Lang::get('ds_del'); ?></a></th>
        </tr>
    </tfoot>
    <?php endif; ?>
</table>
