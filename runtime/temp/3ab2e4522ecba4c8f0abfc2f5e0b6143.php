<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:91:"/usr/local/var/www/dsmall/public/../application/admin/view/statgoods/stat_goods_prange.html";i:1574757822;s:67:"/usr/local/var/www/dsmall/application/admin/view/public/header.html";i:1574757822;s:72:"/usr/local/var/www/dsmall/application/admin/view/public/admin_items.html";i:1574757822;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<div class="page">
    <div class="fixed-bar">
        <div class="item-title">
            <div class="subject">
                <h3><?php echo \think\Lang::get('ds_statgoods'); ?></h3>
                <h5></h5>
            </div>
            <?php if($admin_item): ?>
...
<?php endif; ?>
      ...
      <div class="ds-search-form">
          <dl>
            ...
            <div class="btn_group">
                ...
                <a href="<?php echo url('Statgoods/pricerange'); ?>" class="btn btn-default" title="<?php echo \think\Lang::get('ds_cancel'); ?>"><?php echo \think\Lang::get('ds_cancel'); ?></a>
            </div>
        </div>
    </form>
  ...
  <div class="explanation" id="explanation">
        ...
        <ul>
            ...
            <li><?php echo \think\Lang::get('statgoods_stat_goods_prange_help1'); ?></li>
            <li><?php echo \think\Lang::get('statgoods_stat_goods_prange_help2'); ?></li>
        </ul>
    </div>
  ...
  <table class="ds-default-table">
	<thead class="thead">
		<tr class="space">
			<th colspan="15"><?php echo \think\Lang::get('statgoods_price_distribution'); ?>（<a href="<?php echo url('Statgeneral/setting'); ?>" style="font-size:12px; font-weight:normal;"><?php echo \think\Lang::get('statgeneral_setting'); ?></a>）</th>
		</tr>
	</thead>
	<tbody>
		<tr>
			<td>
              ...
              <?php else: ?>
              <div class="w100pre close_float align-center h36 mt10"><?php echo \think\Lang::get('statgeneral_setting_tips'); ?>
                <a href="<?php echo url('Statgeneral/setting'); ?>" style="font-size:12px; font-weight:normal;"><?php echo \think\Lang::get('statgoods_set_now'); ?></a>
              </div>
              <?php endif; ?>
			</td>
		</tr>
