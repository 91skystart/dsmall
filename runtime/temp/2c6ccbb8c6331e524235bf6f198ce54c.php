...
<?php endif; ?>
        <a href="<?php echo url('Selleraccount/account_add'); ?>" class="dssc-btn dssc-btn-green"  title="<?php echo \think\Lang::get('add_account'); ?>"><?php echo \think\Lang::get('add_account'); ?></a>
        </div>
...
<table class="dssc-default-table">
    <thead>
        <tr><th class="w60"></th>
            <th class="tl"><?php echo \think\Lang::get('member_name'); ?></th>
            <th class="tl"><?php echo \think\Lang::get('account_name'); ?></th>
            <th class="w200"><?php echo \think\Lang::get('account_group'); ?></th>
    ...
    <tbody>
        ...
        <tr class="bd-line">
            <td></td>
            <td class="tl"><?php echo $seller['member_name']; ?></td>
            <td class="tl"><?php echo $seller['seller_name']; ?></td>
            <td><?php echo $seller_group_array[$seller['sellergroup_id']]['sellergroup_name']; ?></td>
            <td class="dscs-table-handle">
                <span><a href="<?php echo url('Selleraccount/account_edit',['seller_id'=>$seller['seller_id']]); ?>" class="btn-blue"><i class="iconfont">&#xe731;</i><p><?php echo \think\Lang::get('ds_edit'); ?></p></a></span>
                <span><a dstype="btn_del_account" data-seller-id="<?php echo $seller['seller_id']; ?>" href="javascript:;" class="btn-red"><i class="iconfont">&#xe725;</i><p><?php echo \think\Lang::get('ds_del'); ?></p></a></span>
            </td>
        </tr>
