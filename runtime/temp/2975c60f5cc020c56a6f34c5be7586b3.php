...
<?php endif; ?>
        ...
        <?php if($newfile == ''): ?>
        <form action="<?php echo url('Memberinformation/upload'); ?>" enctype="multipart/form-data" id="form_avaster" method="post">
            <div class="dsm-default-form">
                <dl>
                    <dt><?php echo \think\Lang::get('home_member_avatar_thumb'); ?><?php echo \think\Lang::get('ds_colon'); ?></dt>
                    <dd>
                        <div class="user-avatar"><span><img src="<?php echo get_member_avatar($member_info['member_avatar']); ?>?<?php echo microtime(); ?>>" alt="" ds_type="avatar" /></span></div>
                        <p class="hint mt5"><?php echo \think\Lang::get('ds_member_avatar_hint'); ?></p>
                    </dd>
                </dl>
                <dl>
                    <dt><?php echo \think\Lang::get('home_member_change_avatar'); ?><?php echo \think\Lang::get('ds_colon'); ?></dt>
                    <dd>
            ...
            <input type="file" hidefocus="true" size="1" class="input-file" name="pic" id="pic" file_id="0" multiple="" maxlength="0"/>
                            ...
                            <p><i class="iconfont">&#xe733;</i><?php echo \think\Lang::get('home_member_avatar_upload'); ?></p>
        ...
        <?php else: ?>
        <form action="<?php echo url('Memberinformation/cut'); ?>" id="form_cut" method="post">
            ...
            <input type="hidden" id="newfile" name="newfile" value="<?php echo $newfile; ?>" />
            <div class="pic-cut-120">
                <div class="work-title"><?php echo \think\Lang::get('ds_comm_workarea'); ?></div>
                <div class="work-layer">
                    <p><img id="dscropbox" src="<?php echo $newfile; ?>?<?php echo microtime(); ?>"/></p>
                </div>
                <div class="thumb-title"><?php echo \think\Lang::get('ds_comm_cut_view'); ?></div>
                <div class="thumb-layer">
                    <p><img id="preview" src="<?php echo $newfile; ?>?<?php echo microtime(); ?>"/></p>
                </div>
                <div class="cut-help">
                    <h4><?php echo \think\Lang::get('ds_comm_op_help'); ?></h4>
                    <p><?php echo \think\Lang::get('ds_comm_op_help_tip'); ?></p>
                </div>
                <div class="cut-btn">
                    <input type="button" id="dssubmit" class="submit" value="<?php echo \think\Lang::get('ds_submit'); ?>" />
                </div>
            </div>
        </form>
        <?php endif; ?>
...
<script src="<?php echo PLUGINS_SITE_ROOT; ?>/js/jcrop/jquery.Jcrop.min.js"></script>
<link rel="stylesheet" href="<?php echo PLUGINS_SITE_ROOT; ?>/js/jcrop/jquery.Jcrop.min.css">
<script type="text/javascript">
    $(function(){
            <?php if($newfile != ''): ?>
            ...
            $('#dssubmit').click(function() {
                ...
                var h = $('#h').val();
                if(x1=="" || y1=="" || x2=="" || y2=="" || w=="" || h==""){
                    layer.msg("<?php echo \think\Lang::get('an_area_must_selected'); ?>");
                    return false;
                }else{
                    $('#form_cut').submit();
                }
        ...
        <?php else: ?>
            $('#pic').change(function(){
                ...
                if(ext!=".PNG"&&ext!=".GIF"&&ext!=".JPG"&&ext!=".JPEG"){
                    layer.msg("<?php echo \think\Lang::get('file_type_error'); ?>");
                    $(this).attr('value','');
                    return false;
                }
...
<div class="server">
    ...
    <div class="mall_desc">
        <?php if(!(empty($article_list) || (($article_list instanceof \think\Collection || $article_list instanceof \think\Paginator ) && $article_list->isEmpty()))): if(is_array($article_list) || $article_list instanceof \think\Collection || $article_list instanceof \think\Paginator): $_5e9557fb9ad43 = is_array($article_list) ? array_slice($article_list,0,4, true) : $article_list->slice(0,4, true); if( count($_5e9557fb9ad43)==0 ) : echo "" ;else: foreach($_5e9557fb9ad43 as $key=>$art): ?>
        <dl> 
