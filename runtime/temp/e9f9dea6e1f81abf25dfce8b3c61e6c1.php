...
<form method="post" target="_self">
    <table class="search-form">
        <tr>
            ...
            <td class="w160"><input type="text" class="text w150" name="orderinviter_order_sn" value="<?php echo \think\Request::instance()->param('orderinviter_order_sn'); ?>"></td>
            <td class="w70 tc">
...
<table class="dssc-default-table">
    <thead>
        <tr>
            <th class="w40"><?php echo \think\Lang::get('commission'); ?></th>
            <th class="w80 tl"><?php echo \think\Lang::get('order_number'); ?></th>
            <th class="w80 tl"><?php echo \think\Lang::get('goods_name'); ?></th>
            <th class="w80 tl"><?php echo \think\Lang::get('goods_quantity'); ?></th>
            <th class="w80 tl"><?php echo \think\Lang::get('goods_amount'); ?></th>
            <th class="w80 tl"><?php echo \think\Lang::get('inviter_name'); ?></th>
            <th class="w80 tl"><?php echo \think\Lang::get('inviter_addtime'); ?></th>
            <th class="w150 tl"><?php echo \think\Lang::get('remark'); ?></th>
            <th class="w40"><?php echo \think\Lang::get('whether_effective'); ?>    </thead>
    <tbody>
        <?php if(!(empty($orderinviter_list) || (($orderinviter_list instanceof \think\Collection || $orderinviter_list instanceof \think\Paginator ) && $orderinviter_list->isEmpty()))): if(is_array($orderinviter_list) || $orderinviter_list instanceof \think\Collection || $orderinviter_list instanceof \think\Paginator): if( count($orderinviter_list)==0 ) : echo "" ;else: foreach($orderinviter_list as $key=>$v): ?>
        <tr class="bd-line">
            <td class="tl">￥<?php echo $v['orderinviter_money']; ?></td>
            <td class="tl"><?php echo $v['orderinviter_order_sn']; ?></td>
            <td class="tl"><?php echo $v['orderinviter_goods_name']; ?></td>
            <td class="tl"><?php echo $v['orderinviter_goods_quantity']; ?></td>
            <td class="tl"><?php echo $v['orderinviter_goods_amount']; ?></td>
            <td class="tl"><?php echo $v['orderinviter_member_name']; ?></td>
            <td class="tl"><?php echo date("Y-m-d H:i",$v['orderinviter_addtime']); ?></td>
            <td class="tl"><?php echo $v['orderinviter_remark']; ?></td>
            <td class="tl"><?php if($v['orderinviter_valid']): ?><?php echo \think\Lang::get('ds_yes'); else: ?><?php echo \think\Lang::get('ds_no'); endif; ?></td>
        </tr>
        <?php endforeach; endif; else: echo "" ;endif; else: ?>
        <tr>
            <td colspan="9" class="norecord"><div class="warning-option"><i>&nbsp;</i><span><?php echo \think\Lang::get('no_record'); ?></span></div></td>
        </tr>
        <?php endif; ?>
    </tbody>
    <tfoot>
        <?php if(!(empty($orderinviter_list) || (($orderinviter_list instanceof \think\Collection || $orderinviter_list instanceof \think\Paginator ) && $orderinviter_list->isEmpty()))): ?>
        <tr>
            <td colspan="9"><div class="pagination"><?php echo $show_page; ?></div></td>
        </tr>
        <?php endif; ?>
    </tfoot>
</table>
