<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:96:"/usr/local/var/www/dsmall/public/../application/home/view/default/mall/article/article_list.html";i:1574757822;s:75:"/usr/local/var/www/dsmall/application/home/view/default/base/base_home.html";i:1574757822;s:74:"/usr/local/var/www/dsmall/application/home/view/default/base/mall_top.html";i:1574757822;s:77:"/usr/local/var/www/dsmall/application/home/view/default/base/mall_header.html";i:1574757822;s:77:"/usr/local/var/www/dsmall/application/home/view/default/base/mall_server.html";i:1574757822;s:77:"/usr/local/var/www/dsmall/application/home/view/default/base/mall_footer.html";i:1574757822;}*/ ?>
<!doctype html>
<html>
    <head>
...
<div class="dsh-container wrapper">
  <div class="left">
    <div class="dsh-module dsh-module-style01">
      ...
      <div class="content">
        <ul class="dsh-sidebar-article-class">
      ...
      <div class="content">
        <ul class="dsh-sidebar-article-list">
          ...
          <li><i class="iconfont">&#xe687;</i>
            <a <?php if($v['article_url'] !=''): ?>target="_blank"<?php endif; ?>
              href="<?php if($v['article_url'] != ''): ?><?php echo $v['article_url']; else: ?><?php echo url('Article/show',['article_id'=>$v['article_id']]); endif; ?>"><?php echo $v['article_title']; ?>
            </a>
          </li>
      ...
      <?php if(!(empty($article) || (($article instanceof \think\Collection || $article instanceof \think\Paginator ) && $article->isEmpty()))): ?>
        <ul class="dsh-article-list">
          <?php if(is_array($article) || $article instanceof \think\Collection || $article instanceof \think\Paginator): if( count($article)==0 ) : echo "" ;else: foreach($article as $key=>$article): ?>
            <li><i></i>
              <a <?php if($article['article_url'] !=""): ?>target="_blank"<?php endif; ?>
                href="<?php if($article['article_url'] !=""): ?><?php echo $article['article_url']; else: ?><?php echo url('Article/show',['article_id'=>$article['article_id']]); endif; ?> ">
       ...
       <?php else: ?>
        <div><?php echo \think\Lang::get('article_article_not_found'); ?></div>
     <?php endif; ?>
    </div> <div class="tc mb20">  <div class="pagination"> <?php echo $show_page; ?> </div></div>
  </div>
</div>
</div>
...
<div class="server">
    ...
    <div class="mall_desc">
        <?php if(!(empty($article_list) || (($article_list instanceof \think\Collection || $article_list instanceof \think\Paginator ) && $article_list->isEmpty()))): if(is_array($article_list) || $article_list instanceof \think\Collection || $article_list instanceof \think\Paginator): $_5e95537d07820 = is_array($article_list) ? array_slice($article_list,0,4, true) : $article_list->slice(0,4, true); if( count($_5e95537d07820)==0 ) : echo "" ;else: foreach($_5e95537d07820 as $key=>$art): ?>
        <dl> 
