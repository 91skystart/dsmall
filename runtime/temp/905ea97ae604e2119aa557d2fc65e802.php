...
<table class="dssc-default-table">
    <thead>
        ...
        <tr>
            ...
            <td colspan="6"><label for="all" ><?php echo \think\Lang::get('ds_select_all'); ?></label>
                ...
                <a href="javascript:void(0);" class="dssc-btn-mini" ds_type="batchbutton" uri="<?php echo url('Sellergoodsonline/goods_unshow'); ?>" name="commonid"><?php echo \think\Lang::get('store_goods_index_unshow'); ?></a>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td<?php if($val['goods_lock'] == 0): ?> class="hover" ds_type="dialog" dialog_width="650" dialog_id="edit_storage" dialog_title="<?php echo \think\Lang::get('edit_storage'); ?>" uri="<?php echo url('Sellergoodsonline/edit_storage',['commonid'=>$val['goods_commonid']]); ?>"<?php endif; ?>><span><?php echo \think\Lang::get('currency'); ?><?php echo $val['goods_price']; ?></span><i class="iconfont hidden">&#xe731;</i></td>
            <td class="hover" ds_type="dialog" dialog_width="650" dialog_id="edit_storage" dialog_title="<?php echo \think\Lang::get('edit_storage'); ?>" uri="<?php echo url('Sellergoodsonline/edit_storage',['commonid'=>$val['goods_commonid']]); ?>"><span <?php if(isset($storage_array[$val['goods_commonid']]['alarm'])): ?>style="color:red;"<?php endif; ?>><?php echo $storage_array[$val['goods_commonid']]['sum']; ?><?php echo \think\Lang::get('piece'); ?></span><i class="iconfont hidden">&#xe731;</i></td>
            ...
            <td class="dscs-table-handle">
                ...
                <span><a href="<?php echo url('Sellergoodsonline/edit_goods',['commonid'=>$val['goods_commonid']]); ?>" class="btn-blue"><i class="iconfont">&#xe731;</i>
                    ...
                    </a></span> <span><a href="javascript:void(0);" onclick="ds_ajaxget_confirm('<?php echo url('Sellergoodsonline/drop_goods',['commonid'=>$val['goods_commonid']]); ?>','<?php echo \think\Lang::get('ds_ensure_del'); ?>');" class="btn-red"><i class="iconfont">&#xe725;</i>
                        <p><?php echo \think\Lang::get('ds_del'); ?></p>
                    </a></span>
                <?php else: ?>
                <span class="tip" title="<?php echo \think\Lang::get('participate_activity_operation'); ?>"><a readonly="readonly" class="btn-orange-current"><i class="iconfont">&#xe768;</i>
        ...
        <tr>
            <td colspan="7" class="norecord"><div class="warning-option"><i class="iconfont">&#xe64c;</i><span><?php echo \think\Lang::get('no_record'); ?></span></div></td>
        </tr>
        <?php endif; ?>
    </tbody>
    <tfoot>
        ...
        <tr>
            ...
            <th colspan="6"><label for="all2"><?php echo \think\Lang::get('ds_select_all'); ?></label>
                <a href="javascript:void(0);" ds_type="batchbutton" uri="<?php echo url('Sellergoodsonline/drop_goods'); ?>" name="commonid" confirm="<?php echo \think\Lang::get('ds_ensure_del'); ?>" class="dssc-btn-mini"><i class="iconfont">&#xe725;</i><?php echo \think\Lang::get('ds_del'); ?></a>
                <a href="javascript:void(0);" ds_type="batchbutton" uri="<?php echo url('Sellergoodsonline/goods_unshow'); ?>" name="commonid" class="dssc-btn-mini"><?php echo \think\Lang::get('store_goods_index_unshow'); ?></a>
                <a href="javascript:void(0);" class="dssc-btn-mini" dstype="batch" data-param="{urls:'<?php echo url('Sellergoodsonline/edit_jingle'); ?>', sign:'jingle'}"><?php echo \think\Lang::get('advertising'); ?></a>
                <a href="javascript:void(0);" class="dssc-btn-mini" dstype="batch" data-param="{urls:'<?php echo url('Sellergoodsonline/edit_plate'); ?>', sign:'plate'}"><?php echo \think\Lang::get('set_associated_layout'); ?></a>
            </th>
        </tr>
        <tr>
