...
<form method="post" target="_self">
    <table class="dsm-search-table">
        <tr>
            <th><?php echo \think\Lang::get('inviter_order_number'); ?></th>
...
<table class="dsm-default-table">
    <thead>
        <tr>
            <th class="w40"><?php echo \think\Lang::get('inviter_commission'); ?></th>
            <th class="w80 tl"><?php echo \think\Lang::get('inviter_order_number'); ?></th>
            <th class="w150 tl"><?php echo \think\Lang::get('inviter_remark'); ?></th>
            <th class="w40"><?php echo \think\Lang::get('inviter_valid'); ?></th>
        </tr>
    </thead>
    <tbody>
...
<div class="server">
    ...
    <div class="mall_desc">
        <?php if(!(empty($article_list) || (($article_list instanceof \think\Collection || $article_list instanceof \think\Paginator ) && $article_list->isEmpty()))): if(is_array($article_list) || $article_list instanceof \think\Collection || $article_list instanceof \think\Paginator): $_5e954764bf872 = is_array($article_list) ? array_slice($article_list,0,4, true) : $article_list->slice(0,4, true); if( count($_5e954764bf872)==0 ) : echo "" ;else: foreach($_5e954764bf872 as $key=>$art): ?>
        <dl> 
