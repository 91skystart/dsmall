...
<form method="get" action="<?php echo url('Membervrrefund/index'); ?>">
            <table class="dsm-search-table">
                <tr>
                    <td>&nbsp;</td>
                    <th><?php echo \think\Lang::get('refund_buyer_add_time'); ?></th>
                    <td class="w240"><input name="add_time_from" id="add_time_from" type="text" class="text w70" value="<?php echo \think\Request::instance()->get('add_time_from'); ?>"/><label class="add-on"><i class="iconfont">&#xe8d6;</i></label>&nbsp;&#8211;&nbsp;
                        <input name="add_time_to" id="add_time_to" type="text" class="text w70" value="<?php echo \think\Request::instance()->get('add_time_to'); ?>"/><label class="add-on"><i class="iconfont">&#xe8d6;</i></label></td>
                    <th><select name="type">
                        <option value="order_sn" <?php if(\think\Request::instance()->get('type')== 'order_sn'): ?>selected<?php endif; ?>>
                        <?php echo \think\Lang::get('refund_order_ordersn'); ?>
                        </option>
                        <option value="refund_sn" <?php if(\think\Request::instance()->get('type')== 'refund_sn'): ?>selected<?php endif; ?>>
                        <?php echo \think\Lang::get('refund_order_refundsn'); ?>
                        </option>
                        <option value="goods_name" <?php if(\think\Request::instance()->get('type')== 'goods_name'): ?>selected<?php endif; ?>>
                       <?php echo \think\Lang::get('return_goods_name'); ?>
                        </option>
                    </select></th>
                    <td class="w160"><input type="text" class="text w150" name="key" value="<?php echo \think\Request::instance()->get('key'); ?>"/></td>
                    <td class="w70 tc">
        ...
        <table class="dsm-default-table order">
            ...
            <tr>
                ...
                <th class="w100"><?php echo \think\Lang::get('refund_order_refund'); ?>（<?php echo \think\Lang::get('ds_yuan'); ?>）</th>
                <th class="w100"><?php echo \think\Lang::get('refund_state'); ?></th>
            ...
            <tr>
                <th colspan="20">
                    <span class="ml10"><?php echo \think\Lang::get('refund_order_refundsn'); ?><?php echo \think\Lang::get('ds_colon'); ?><?php echo $val['refund_sn']; ?></span>
                        <span><?php echo \think\Lang::get('refund_buyer_add_time'); ?><?php echo \think\Lang::get('ds_colon'); ?><?php echo date('Y-m-d H:i:s',$val['add_time']); ?></span>
                        <!-- store_name -->
                    <span>
                        <a href="<?php echo url('Store/index',['store_id'=>$val['store_id']]); ?>" title="<?php echo $val['store_name']; ?>"><?php echo $val['store_name']; ?></a></span>
                    <span member_id="<?php echo $store_list[$val['store_id']]['member_id']; ?>">
          <!-- QQ -->
                        <?php if(!(empty($store_list[$val['store_id']]['store_qq']) || (($store_list[$val['store_id']]['store_qq'] instanceof \think\Collection || $store_list[$val['store_id']]['store_qq'] instanceof \think\Paginator ) && $store_list[$val['store_id']]['store_qq']->isEmpty()))): ?>
                        <a target="_blank" href="<?php echo HTTP_TYPE; ?>wpa.qq.com/msgrd?v=3&uin=<?php echo $store_list[$val['store_id']]['store_qq']; ?>&site=qq&menu=yes" title="QQ: <?php echo $store_list[$val['store_id']]['store_qq']; ?>">
                            <img border="0" src="<?php echo HTTP_TYPE; ?>wpa.qq.com/pa?p=2:<?php echo $store_list[$val['store_id']]['store_qq']; ?>:52" style=" vertical-align: middle;"/></a>
                      <?php endif; ?>

                        <!-- wang wang -->
                        <?php if(!(empty($store_list[$val['store_id']]['store_ww']) || (($store_list[$val['store_id']]['store_ww'] instanceof \think\Collection || $store_list[$val['store_id']]['store_ww'] instanceof \think\Paginator ) && $store_list[$val['store_id']]['store_ww']->isEmpty()))): ?>
                        <a target="_blank" href="http://amos.im.alisoft.com/msg.aw?v=2&uid=<?php echo $store_list[$val['store_id']]['store_ww']; ?>&site=cntaobao&s=2" class="vm">
                            <img border="0" src="http://amos.im.alisoft.com/online.aw?v=2&uid=<?php echo $store_list[$val['store_id']]['store_ww']; ?>&site=cntaobao&s=2" alt="Wang Wang" style=" vertical-align: middle;"/></a>
                        <?php endif; ?>
          </span>
                </th>
            </tr>
            <tr class="bd-line">
                <td class="bdl"></td>
                <td class="w50">
                    <div class="pic-thumb"><a  href="<?php echo url('Goods/index',['goods_id'=>$val['goods_id']]); ?>" target="_blank"><img src="<?php echo goods_thumb($val); ?>"/></a></div>
                </td>
                <td class="tl">
                    <dl class="goods-name">
                        <dt><a href="<?php echo url('Goods/index',['goods_id'=>$val['goods_id']]); ?>" target="_blank"><?php echo $val['goods_name']; ?></a></dt>
                        <dd><?php echo \think\Lang::get('refund_order_ordersn'); ?><?php echo \think\Lang::get('ds_colon'); ?>
                            <a href="<?php echo url('Membervrorder/show_order',['order_id'=>$val['order_id']]); ?>" target="_blank"><?php echo $val['order_sn']; ?></a></dd>
                    </dl>
                </td>
                <td><?php echo $val['refund_amount']; ?></td>
                <td><?php echo $admin_array[$val['admin_state']]; ?></td>
                <td class="bdr"><a  href="<?php echo url('Membervrrefund/view',['refund_id'=>$val['refund_id']]); ?>" class="dsm-btn"><?php echo \think\Lang::get('ds_view'); ?> </a></td>
            </tr>
            <?php endforeach; endif; else: echo "" ;endif; ?>
            </tbody>
            <tfoot>
...
<div class="server">
    ...
    <div class="mall_desc">
        <?php if(!(empty($article_list) || (($article_list instanceof \think\Collection || $article_list instanceof \think\Paginator ) && $article_list->isEmpty()))): if(is_array($article_list) || $article_list instanceof \think\Collection || $article_list instanceof \think\Paginator): $_5e9557602fdad = is_array($article_list) ? array_slice($article_list,0,4, true) : $article_list->slice(0,4, true); if( count($_5e9557602fdad)==0 ) : echo "" ;else: foreach($_5e9557602fdad as $key=>$art): ?>
        <dl> 
