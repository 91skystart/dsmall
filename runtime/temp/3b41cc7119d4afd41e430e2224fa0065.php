<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:87:"/usr/local/var/www/dsmall/public/../application/home/view/default/mall/index/index.html";i:1574757822;s:75:"/usr/local/var/www/dsmall/application/home/view/default/base/base_home.html";i:1574757822;s:74:"/usr/local/var/www/dsmall/application/home/view/default/base/mall_top.html";i:1574757822;s:77:"/usr/local/var/www/dsmall/application/home/view/default/base/mall_header.html";i:1574757822;s:77:"/usr/local/var/www/dsmall/application/home/view/default/base/mall_server.html";i:1574757822;s:77:"/usr/local/var/www/dsmall/application/home/view/default/base/mall_footer.html";i:1574757822;}*/ ?>
<!doctype html>
<html>
    <head>
...
<div class="home-focus-layout">
    <div class="bd">
        <ul>
            <?php $ap_id =1;$ad_position = db("advposition")->cache(3600)->column("ap_id,ap_name,ap_width,ap_height","ap_id");$result = db("adv")->where("ap_id=$ap_id  and adv_enabled = 1 and adv_startdate < 1586833200 and adv_enddate > 1586833200 ")->order("adv_sort desc")->cache(3600)->limit("10")->select();
if(!in_array($ap_id,array_keys($ad_position)) && $ap_id)
{
  db("advposition")->insert(array(
         "ap_id"=>$ap_id,
    ...
    <div class="right-sidebar">
        <div class="mod_personal_center">
            ...
            <div class="avata_pic_wrap">
                <a id="index_account_icon_login" href="<?php echo url('Member/index'); ?>" target="_blank"><img class="lazyload"  data-original="<?php echo get_member_avatar(\think\Session::get('avatar')); ?>?<?php echo TIMESTAMP; ?>"></a>
            </div>
            <div class="info_wrap">
                <div class="login_box">
            ...
            <?php else: ?>
            <div class="avata_pic_wrap">
                <a id="index_account_icon_unlogin" href="javascript:void(0)"><img class="lazyload"  data-original="<?php echo get_member_avatar(\think\Session::get('avatar')); ?>?<?php echo TIMESTAMP; ?>"></a>
            </div>
            <div class="info_wrap">
...
<div class="home-scroll w1200 mt10">
    <div class="bd">
        <ul>
            <li>
                <?php $ap_id =2;$ad_position = db("advposition")->cache(3600)->column("ap_id,ap_name,ap_width,ap_height","ap_id");$result = db("adv")->where("ap_id=$ap_id  and adv_enabled = 1 and adv_startdate < 1586833200 and adv_enddate > 1586833200 ")->order("adv_sort desc")->cache(3600)->limit("10")->select();
if(!in_array($ap_id,array_keys($ad_position)) && $ap_id)
{
  db("advposition")->insert(array(
         "ap_id"=>$ap_id,
...
<!--首页悬浮弹窗BEGIN-->
<?php if(\think\Config::get('fixed_suspension_state')): ?>
<div class="fixed-suspension-layer" style="display: none;">
    <div class="fixed-suspension-con">
        <a href="<?php echo \think\Config::get('fixed_suspension_url'); ?>" class="fixed-suspension-img">
		<img class="lazy" src="<?php echo UPLOAD_SITE_URL; ?>/<?php echo ATTACH_COMMON; ?>/<?php echo \think\Config::get('fixed_suspension_img'); ?>">
        </a>
...
<div class="fsFixedTopContent" style="visibility: hidden; display: block;">
    <div class="fsFixedTop" style="opacity: 0;"> 
        <?php if(is_array($floor_block) || $floor_block instanceof \think\Collection || $floor_block instanceof \think\Paginator): if( count($floor_block)==0 ) : echo "" ;else: foreach($floor_block as $k=>$vo): ?>
        <a class="smooth active" href="javascript:;"> <b class="fs"><?php echo $k+1; ?>F</b> <em class="fs-name"><?php echo $vo['gc_name']; ?></em> </a> 
        <?php endforeach; endif; else: echo "" ;endif; ?>
    </div>
    </div>		
<script>
...
<div class="server">
    ...
    <div class="mall_desc">
        <?php if(!(empty($article_list) || (($article_list instanceof \think\Collection || $article_list instanceof \think\Paginator ) && $article_list->isEmpty()))): if(is_array($article_list) || $article_list instanceof \think\Collection || $article_list instanceof \think\Paginator): $_5e952b6671ad4 = is_array($article_list) ? array_slice($article_list,0,4, true) : $article_list->slice(0,4, true); if( count($_5e952b6671ad4)==0 ) : echo "" ;else: foreach($_5e952b6671ad4 as $key=>$art): ?>
        <dl> 
