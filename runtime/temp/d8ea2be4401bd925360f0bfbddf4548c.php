...
<div class="page">
    <div class="fixed-bar">
        <div class="item-title">
            <div class="subject">
                <h3><?php echo \think\Lang::get('ds_vrrefund'); ?></h3>
            </div>
            <?php if($admin_item): ?>
...
<?php endif; ?>
  ...
  <form method="get" action="" name="formSearch" id="formSearch">
      <div class="ds-search-form">
          ...
          <dl>
              <dt><?php echo \think\Lang::get('return_order_add_time'); ?></dt>
              <dd>
            ...
            <div class="btn_group">
                ...
                <?php if($filtered): ?>
                <a href="<?php echo url('Vrrefund/refund_manage'); ?>" class="btn btn-default" title="<?php echo \think\Lang::get('ds_cancel'); ?>"><?php echo \think\Lang::get('ds_cancel'); ?></a>
                <?php endif; ?>
            </div>
        </div>
  </form>
  ...
  <div class="explanation" id="explanation">
      ...
      <ul>
          <li><?php echo \think\Lang::get('vrrefund_manage_list_help1'); ?></li>
      </ul>
  </div>
      ...
      <tbody>
          ...
          <tr class="bd-line" >
              ...
              <td class="align-center">
                  <a href="javascript:dsLayerOpen('<?php echo url('Vrrefund/edit',['refund_id'=>$val['refund_id']]); ?>','<?php echo \think\Lang::get('ds_verify'); ?>-<?php echo $val['buyer_name']; ?>')" class="dsui-btn-edit"><i class="iconfont"></i><?php echo \think\Lang::get('ds_verify'); ?></a>
              </td>
          </tr>
          <?php endforeach; endif; else: echo "" ;endif; ?>
      </tbody>
