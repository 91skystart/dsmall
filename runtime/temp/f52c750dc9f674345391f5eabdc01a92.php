<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:83:"/usr/local/var/www/dsmall/public/../application/admin/view/storesnstrace/index.html";i:1574757822;s:67:"/usr/local/var/www/dsmall/application/admin/view/public/header.html";i:1574757822;s:72:"/usr/local/var/www/dsmall/application/admin/view/public/admin_items.html";i:1574757822;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<div class="page">
    <div class="fixed-bar">
        <div class="item-title">
            <div class="subject">
                <h3><?php echo \think\Lang::get('ds_storesnstrace'); ?></h3>
                <h5></h5>
            </div>
            <?php if($admin_item): ?>
    ...
    <form method="get" name="formSearch">
        <div class="ds-search-form">
            <dl>
                ...
                <dd><input type="text" value="<?php echo \think\Request::instance()->get('search_sname'); ?>" name="search_sname" id="search_sname" class="txt"></dd>
            </dl>
            <dl>
                <dt><?php echo \think\Lang::get('admin_snstrace_title'); ?></dt>
                <dd><input type="text" value="<?php echo \think\Request::instance()->get('search_stitle'); ?>" name="search_stitle" id="search_stitle" class="txt"></dd>
            </dl>
            <dl>
                <dt><?php echo \think\Lang::get('admin_snstrace_content'); ?></dt>
                <dd><input type="text" value="<?php echo \think\Request::instance()->get('search_scontent'); ?>" name="search_scontent" id="search_scontent" class="txt"></dd>
            </dl>
            <dl>
                <dt><?php echo \think\Lang::get('store_sns_trace_type'); ?></dt>
                <dd>
            ...
            <dl>
                <dt><?php echo \think\Lang::get('admin_snstrace_addtime'); ?></dt>
                <dd>
                    <input type="text" class="txt date" value="<?php echo \think\Request::instance()->get('search_stime'); ?>" name="search_stime" id="search_stime" class="txt">
                    ~
            ...
            <div class="btn_group">
                ...
                <a href="<?php echo url('Storesnstrace/index'); ?>" class="btn btn-default" title="<?php echo \think\Lang::get('ds_cancel'); ?>"><?php echo \think\Lang::get('ds_cancel'); ?></a>
            </div>
        </div>
    </form>
    <div class="explanation" id="explanation">
        ...
        <table class="ds-default-table">
            <tbody>
                ...
                <tr class="hover edit">
                    <td style="vertical-align:top;"><input type="checkbox" name="st_id[]" value="<?php echo $v['stracelog_id']; ?>" class="checkitem"></td>
                    <td class="fd-list">
                        <!-- 动态列表start -->
                    <li>
                        <div class="fd-aside">
                            <span class="thumb size60">
                                <a href="<?php echo url('home/Storesnshome/index',['sid'=>$v['stracelog_storeid']]); ?>" target="_blank">
                        ...
                        <dl class="fd-wrap">
                            <dt>
                                <h3><a href="<?php echo url('home/Storesnshome/index',['sid'=>$v['stracelog_storeid']]); ?>" target="_blank"><?php echo $v['stracelog_storename']; ?></a><?php echo \think\Lang::get('ds_colon'); ?></h3>
                            ...
                            <dd>
                                ...
                                <span class="fr"><?php echo \think\Lang::get('admin_snstrace_forward'); ?>&nbsp;|&nbsp;
                                    <a href="<?php echo url('Storesnstrace/storecomment_list',['st_id'=>$v['stracelog_id']]); ?>"><?php echo \think\Lang::get('admin_snstrace_comment'); ?><?php echo $v['stracelog_comment']>0?($v['stracelog_comment']):''; ?></a>
                                </span>&nbsp;&nbsp;
                                <?php echo \think\Lang::get('admin_snstrace_state'); ?><?php echo \think\Lang::get('ds_colon'); if($v['stracelog_state'] ==0): ?><font style='color:red;'><?php echo \think\Lang::get('admin_snstrace_statehide'); ?></font><?php else: ?><?php echo \think\Lang::get('admin_snstrace_stateshow'); endif; ?></span>
                            </dd>
                            <div class="clear"></div>
                        </dl>
                    </li>
            ...
            <tfoot>
                <tr class="tfoot">
                    ...
                    <td colspan="16"><label for="checkallBottom"><?php echo \think\Lang::get('ds_select_all'); ?></label>
                        ...
                        <a href="JavaScript:void(0);" class="btn btn-small" onclick="submit_edit_batch('hide');"><span><?php echo \think\Lang::get('admin_snstrace_statehide'); ?></span></a>
                        <a href="JavaScript:void(0);" class="btn btn-small" onclick="submit_edit_batch('show');"><span><?php echo \think\Lang::get('admin_snstrace_stateshow'); ?></span></a>
                    </td>
                </tr>
            </tfoot>
            <?php else: ?>
...
<script type="text/javascript">
    ...
    function submit_edit_batch(type) {
        ...
        if (items != '') {
            ...
            layer.alert('<?php echo \think\Lang::get('admin_snstrace_pleasechoose_del'); ?>', {icon: 2})  
        }
    }
    function submit_edit(ids_str,type){
        _uri = ADMINSITEURL+"/Storesnstrace/strace_edit.html?st_id=" + ids_str+"&type="+type;
        dsLayerConfirm(_uri,'<?php echo \think\Lang::get('ds_ensure_operation'); ?>');
    }
