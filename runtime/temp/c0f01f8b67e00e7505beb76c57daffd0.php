<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:75:"/usr/local/var/www/dsmall/public/../application/admin/view/index/index.html";i:1574757822;s:67:"/usr/local/var/www/dsmall/application/admin/view/public/header.html";i:1574757822;s:67:"/usr/local/var/www/dsmall/application/admin/view/public/topnav.html";i:1574757822;s:65:"/usr/local/var/www/dsmall/application/admin/view/public/left.html";i:1574757822;s:67:"/usr/local/var/www/dsmall/application/admin/view/public/footer.html";i:1574757822;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<div class="admincp-header">
    ...
    <div class="navbar">
        <ul class="fl" style="float:left;">
            ...
            <li id="nav_<?php echo $menu['name']; ?>" <?php if(!$menu['show']): ?>style="display:none"<?php endif; ?>>
        ...
        <ul class="fr" style="float:right">
            <li>
                <span><?php echo \think\Lang::get('topnav_hello'); ?>,<?php echo \think\Session::get('admin_name'); ?></span>
                <div class="sub-meun">
                    <dl>
                        <dd><a href="<?php echo url('Index/modifypw'); ?>" target="main-frame"><i class="iconfont">&#xe67b;</i><?php echo \think\Lang::get('topnav_edit_password'); ?></a></dd>
                        <dd><a href="javascript:dsLayerConfirm('<?php echo url('Login/logout'); ?>','<?php echo \think\Lang::get('topnav_logout_confirm'); ?>')"><i class="iconfont">&#xe70c;</i><?php echo \think\Lang::get('topnav_logout'); ?></a></dd>
                    </dl>
                </div>
            </li>
            <li><a href="javascript:dsLayerConfirm('<?php echo url('Index/clear'); ?>','<?php echo \think\Lang::get('topnav_clear_confirm'); ?>')" target="main-frame"><?php echo \think\Lang::get('topnav_cache'); ?></a></li>
            <li><a href="<?php echo url('/Home/Index/index'); ?>" target="_blank"><?php echo \think\Lang::get('topnav_visit_home'); ?></a></li>
        </ul>
    </div>
</div>
