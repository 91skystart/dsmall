        ...
        <div class="mc-user-card fl">
            ...
            <div class="user-head fl">
                <div class="user-canvas "> 
                    <a href="<?php echo url('Pointgrade/index'); ?>" class="level_name"><?php echo $home_member_info['level_name']; ?></a>
                    <div class="canvas-bg">
                ...
                <p class="user-img">
                    <img src="<?php echo get_member_avatar($home_member_info['member_avatar']); ?>?<?php echo TIMESTAMP; ?>">
                </p>
            </div>
        ...
        <div class="mc-user-huaban fl">
            <ul>
                <li>
                    ...
                    <p class="p-dec"><?php echo \think\Lang::get('point'); ?></p>
    ...
    <div class="mc-order-portal">
        <ul>
            <li class="portal-icon-1">
                <a href="<?php echo url('Memberorder/index',['state_type'=>'state_new']); ?>"><span class="iconfont">&#xe6a1;<?php if($home_order_info['order_nopay_count']): ?><b><?php echo $home_order_info['order_nopay_count']; ?></b><?php endif; ?></span><?php echo \think\Lang::get('order_nopay'); ?></a>
            </li>
            <li class="portal-icon-5">
                <a href="<?php echo url('Memberorder/index',['state_type'=>'state_pay']); ?>"><span class="iconfont">&#xe6ef;<?php if($home_order_info['order_noship_count']): ?><b><?php echo $home_order_info['order_noship_count']; ?></b><?php endif; ?></span><?php echo \think\Lang::get('order_noship'); ?></a>
            </li>
            <li class="portal-icon-2">
                <a href="<?php echo url('Memberorder/index',['state_type'=>'state_send']); ?>"><span class="iconfont">&#xe6f1;<?php if($home_order_info['order_noreceipt_count']): ?><b><?php echo $home_order_info['order_noreceipt_count']; ?></b><?php endif; ?></span><?php echo \think\Lang::get('order_noreceipt'); ?></a>
            </li>
            <li class="portal-icon-3">
                <a href="<?php echo url('Memberorder/index',['state_type'=>'state_noeval']); ?>"><span class="iconfont">&#xe730;<?php if($home_order_info['order_noeval_count']): ?><b><?php echo $home_order_info['order_noeval_count']; ?></b><?php endif; ?></span><?php echo \think\Lang::get('order_noeval'); ?></a>
            </li>
            <li class="portal-icon-4">
                <a href="<?php echo url('memberrefund/index'); ?>"><span class="iconfont">&#xe717;<?php if($home_order_info['order_refund_count']): ?><b><?php echo $home_order_info['order_refund_count']; ?></b><?php endif; ?></span><?php echo \think\Lang::get('order_refund'); ?></a>
            </li>
...
<div class="mc-right">
    <div class="mc-security">
        ...
        <div class="detail"><span class="iconfont bg-orange2">&#xe60e;</span><?php echo \think\Lang::get('bind_mobile_phone'); ?><span class="state fr <?php if($home_member_info['member_mobilebind'] == 1): ?>active<?php endif; ?>"><?php if($home_member_info['member_mobilebind'] == 1): ?><?php echo \think\Lang::get('bound'); else: ?><?php echo \think\Lang::get('unbound'); endif; ?></span></div>
        <div class="detail"><span class="iconfont bg-purple3 f14">&#xe75a;</span><?php echo \think\Lang::get('bind_mailbox'); ?><span class="state fr <?php if($home_member_info['member_emailbind'] == 1): ?>active<?php endif; ?>"><?php if($home_member_info['member_emailbind'] == 1): ?><?php echo \think\Lang::get('bound'); else: ?><?php echo \think\Lang::get('unbound'); endif; ?></span></div>
    </div>
</div>   
...
<div class="server">
    ...
    <div class="mall_desc">
        <?php if(!(empty($article_list) || (($article_list instanceof \think\Collection || $article_list instanceof \think\Paginator ) && $article_list->isEmpty()))): if(is_array($article_list) || $article_list instanceof \think\Collection || $article_list instanceof \think\Paginator): $_5e952bdc31b5b = is_array($article_list) ? array_slice($article_list,0,4, true) : $article_list->slice(0,4, true); if( count($_5e952bdc31b5b)==0 ) : echo "" ;else: foreach($_5e952bdc31b5b as $key=>$art): ?>
        <dl> 
