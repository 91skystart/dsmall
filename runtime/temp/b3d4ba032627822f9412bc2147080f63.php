<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:76:"/usr/local/var/www/dsmall/public/../application/admin/view/appadv/index.html";i:1574757822;s:67:"/usr/local/var/www/dsmall/application/admin/view/public/header.html";i:1574757822;s:72:"/usr/local/var/www/dsmall/application/admin/view/public/admin_items.html";i:1574757822;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
  ...
  <form method="get" action="" name="formSearch">
      <div class="ds-search-form">
          ...
          <div class="btn-group">
              ...
              <?php if($filtered): ?>
              <a href="<?php echo url('Appadv/index'); ?>" class="btn btn-default" title="<?php echo \think\Lang::get('ds_cancel'); ?>"><?php echo \think\Lang::get('ds_cancel'); ?></a>
              <?php endif; ?>
          </div>    
      </div>    
  </form>
      ...
      <tbody>
        ...
        <tr class="hover" id="ds_row_<?php echo $v['ap_id']; ?>">
          ...
          <td class="align-center">
              <a href="<?php echo url('Appadv/adv',['ap_id'=>$v['ap_id']]); ?>" class="dsui-btn-view"><i class="iconfont"></i><?php echo \think\Lang::get('ds_manage'); ?></a>
              <a href="javascript:dsLayerOpen('<?php echo url('Appadv/ap_edit',['ap_id'=>$v['ap_id']]); ?>','<?php echo \think\Lang::get('ds_edit'); ?>-<?php echo $v['ap_name']; ?>')" class="dsui-btn-edit"><i class="iconfont"></i><?php echo \think\Lang::get('ds_edit'); ?></a>
              <a href="javascript:dsLayerConfirm('<?php echo url('Appadv/ap_del',['ap_id'=>$v['ap_id']]); ?>','<?php echo \think\Lang::get('ds_ensure_install'); ?>',<?php echo $v['ap_id']; ?>)" class="dsui-btn-del"><i class="iconfont"></i><?php echo \think\Lang::get('ds_del'); ?></a>
          </td>
        </tr>
