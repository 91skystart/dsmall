<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:83:"/usr/local/var/www/dsmall/public/../application/admin/view/storejoin/help_list.html";i:1574757822;s:67:"/usr/local/var/www/dsmall/application/admin/view/public/header.html";i:1574757822;s:72:"/usr/local/var/www/dsmall/application/admin/view/public/admin_items.html";i:1574757822;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<?php endif; ?>
    ...
    <div class="explanation" id="explanation">
        ...
        <ul>
            <li><?php echo \think\Lang::get('storejoin_help_list_help1'); ?></li>
        </ul>
    </div>
    ...
    <table class="ds-default-table">
        ...
        <tr class="hover">
            ...
            <td class="w150 align-center">
                <a href="<?php echo url('Storejoin/edit_help',['help_id'=>$val['help_id']]); ?>" class="dsui-btn-edit"><i class="iconfont"></i><?php echo \think\Lang::get('ds_edit'); ?></a>
            </td>
        </tr>
