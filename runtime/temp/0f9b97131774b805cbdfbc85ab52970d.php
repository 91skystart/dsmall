...
<?php endif; ?>
 ...
 <div class="alert alert-block">
            <h4><?php echo \think\Lang::get('rules_integral_acquisition'); ?></h4>
            <ul>
                <li><?php echo \think\Lang::get('rule_description1'); ?><em><?php echo \think\Config::get('points_reg'); ?></em><?php echo \think\Lang::get('rule_description2'); ?><em><?php echo \think\Config::get('points_login'); ?></em><?php echo \think\Lang::get('rule_description3'); ?><em><?php echo \think\Config::get('points_comments'); ?></em><?php echo \think\Lang::get('member_pointorder_exchangepoints'); ?>。
                </li>
                <?php if(\think\Config::get('points_orderrate')): ?>
                <li><?php echo \think\Lang::get('rule_description4'); printf('%s',number_format(100/config('points_orderrate'))); ?>%<?php if(\think\Config::get('points_ordermax')): ?>（<?php echo \think\Lang::get('rule_description5'); ?><?php echo \think\Config::get('points_ordermax'); ?>）<?php endif; ?><?php echo \think\Lang::get('member_pointorder_exchangepoints'); ?>。</li>
                <?php endif; ?>
                <li><?php echo \think\Lang::get('rule_description6'); ?></li>
            </ul>
        </div>
        <form method="get" action="">
            <table class="dsm-search-table">
                <tr>
                    <td class="w10">&nbsp;</td>
                    <td><strong> <?php echo \think\Lang::get('points_log_pointscount'); ?></strong><strong style="color: #F00;"><?php echo $member_points['member_points']; ?></strong>
                    </td>
                    <th><?php echo \think\Lang::get('points_addtime'); ?></th>
                    <td class="w240"><input type="text" id="stime" name="stime" class="text w70"  value="<?php echo \think\Request::instance()->get('stime'); ?>">
                        <label class="add-on"><i class="iconfont">&#xe8d6;</i></label>&nbsp;&#8211;&nbsp;
                        <input type="text" id="etime" name="etime" class="text w70" value="<?php echo \think\Request::instance()->get('etime'); ?>">
                        <label class="add-on"><i class="iconfont">&#xe8d6;</i></label>
                    </td>
                    <th> <?php echo \think\Lang::get('points_stage'); ?></th>
                    <td class="w100">
                        <select name="stage">
                            <option value="" <?php if(!\think\Request::instance()->get('stage')): ?>selected=selected<?php endif; ?>>
                                <?php echo \think\Lang::get('ds_please_choose'); ?>
                            </option>
                            <option value="regist" <?php if(\think\Request::instance()->get('stage') == 'regist'): ?>selected=selected<?php endif; ?>><?php echo \think\Lang::get('points_stage_regist'); ?></option>
                            <option value="login" <?php if(\think\Request::instance()->get('stage') == 'login'): ?>selected=selected<?php endif; ?>><?php echo \think\Lang::get('points_stage_login'); ?></option>
                            <option value="comments" <?php if(\think\Request::instance()->get('stage') == 'comments'): ?>selected=selected<?php endif; ?>><?php echo \think\Lang::get('points_stage_comments'); ?></option>
                            <option value="order" <?php if(\think\Request::instance()->get('stage') == 'order'): ?>selected=selected<?php endif; ?>><?php echo \think\Lang::get('points_stage_order'); ?></option>
                            <option value="system" <?php if(\think\Request::instance()->get('stage') == 'system'): ?>selected=selected<?php endif; ?>><?php echo \think\Lang::get('points_stage_system'); ?></option>
                            <option value="pointorder" <?php if(\think\Request::instance()->get('stage') == 'pointorder'): ?>selected=selected<?php endif; ?>><?php echo \think\Lang::get('points_stage_pointorder'); ?></option>
                            <option value="app" <?php if(\think\Request::instance()->get('stage') == 'app'): ?>selected=selected<?php endif; ?>><?php echo \think\Lang::get('points_stage_app'); ?></option>
                        </select>
                    </td>
                    <th><?php echo \think\Lang::get('points_pointsdesc'); ?></th>
                    <td class="w160"><input type="text" class="text w150" id="description" name="description" value="<?php echo \think\Request::instance()->get('description'); ?>"></td>
                    <td class="w70 tc">
        ...
        <table class="dsm-default-table">
            <thead>
            <tr>
                <th class="w200"><?php echo \think\Lang::get('points_addtime'); ?></th>
                <th class="w150"><?php echo \think\Lang::get('points_pointsnum'); ?></th>
                <th class="w300"><?php echo \think\Lang::get('points_stage'); ?></th>
                <th class="tl"><?php echo \think\Lang::get('points_pointsdesc'); ?></th>
            </tr>
            </thead>
            <tbody>
            ...
            <tr class="bd-line">
                <td class="goods-time"><?php echo date("Y-m-d",$log['pl_addtime']); ?></td>
                <td class="goods-price"><?php echo $log['pl_points']>0?'+' : ''; ?><?php echo $log['pl_points']; ?></td>
                <td><?php $lang='points_stage_'.$log['pl_stage'];echo lang($lang); ?></td>
                <td class="tl"><?php echo $log['pl_desc']; ?></td>
            </tr>
            <?php endforeach; endif; else: echo "" ;endif; else: ?>
            <tr>
                <td colspan="20" class="norecord">
                    <div class="warning-option"><i>&nbsp;</i><span><?php echo \think\Lang::get('no_record'); ?></span>
                    </div>
                </td>
            </tr>
            <?php endif; ?>
            ...
            <tfoot>
            <?php if(!(empty($list_log) || (($list_log instanceof \think\Collection || $list_log instanceof \think\Paginator ) && $list_log->isEmpty()))): ?>
            <tr>
                <td colspan="20">
...
<div class="server">
    ...
    <div class="mall_desc">
        <?php if(!(empty($article_list) || (($article_list instanceof \think\Collection || $article_list instanceof \think\Paginator ) && $article_list->isEmpty()))): if(is_array($article_list) || $article_list instanceof \think\Collection || $article_list instanceof \think\Paginator): $_5e954653d054e = is_array($article_list) ? array_slice($article_list,0,4, true) : $article_list->slice(0,4, true); if( count($_5e954653d054e)==0 ) : echo "" ;else: foreach($_5e954653d054e as $key=>$art): ?>
        <dl> 
