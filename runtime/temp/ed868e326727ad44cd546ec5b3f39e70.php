...
<div class="dsm-bind">
    <?php if(!(empty($member_info['member_qqopenid']) || (($member_info['member_qqopenid'] instanceof \think\Collection || $member_info['member_qqopenid'] instanceof \think\Paginator ) && $member_info['member_qqopenid']->isEmpty()))): ?>
    <div class="alert">
        <h4><?php echo \think\Lang::get('prompt_information'); ?>：</h4>
        <ul>
            <li><?php echo \think\Lang::get('member_qqconnect_binding_tip_1'); ?><em>“<?php echo session('member_name'); ?>”</em>
                <?php echo \think\Lang::get('member_qqconnect_binding_tip_2'); ?><em>“<?php echo $member_info['member_qqinfoarr']['nickname']; ?>”</em>
                <?php echo \think\Lang::get('member_qqconnect_binding_tip_3'); ?></li>
            <li><?php echo \think\Lang::get('member_qqconnect_modpw_tip_1'); ?><em>“<?php echo session('member_name'); ?>”</em><?php echo \think\Lang::get('member_qqconnect_modpw_tip_2'); ?></li>
        </ul>
    </div>
    <div class="relieve">
        <form method="post" id="editbind_form" name="editbind_form" action="<?php echo url('Memberconnect/qqunbind'); ?>">
            <input type='hidden' id="is_editpw" name="is_editpw" value='no'/>
            <div class="ico-qq"></div>
            <p><?php echo \think\Lang::get('member_qqconnect_unbind_click'); ?></p>
            <div class="bottom">
                <input class="submit" type="submit" value="<?php echo \think\Lang::get('member_qqconnect_unbind_submit'); ?>" />
            </div>
        </form>
    </div>
    <div class="revise dsm-default-form ">
        <form method="post" id="editpw_form" name="editpw_form" action="<?php echo url('Memberconnect/qqunbind'); ?>">
            <input type='hidden' id="is_editpw" name="is_editpw" value='yes'/>
            <dl>
                <dt><?php echo \think\Lang::get('member_qqconnect_modpw_newpw'); ?><?php echo \think\Lang::get('ds_colon'); ?></dt>
                <dd>
            ...
            <dl>
                <dt><?php echo \think\Lang::get('member_qqconnect_modpw_two_password'); ?><?php echo \think\Lang::get('ds_colon'); ?></dt>
                <dd>
            ...
            <dl class="bottom">
                <dt></dt>
                <dd>
                    <input class="submit" type="submit" value="<?php echo \think\Lang::get('member_qqconnect_unbind_updatepw_submit'); ?>" />
                </dd>
            </dl>
        </form>
    </div>
    ...
    <div class="relieve pt50">
        <p class="ico">
            <a href="<?php echo url('Api/oa_qq'); ?>"><img src="<?php echo HOME_SITE_ROOT; ?>/images/qq_bind_small.gif"></a>
        <p class="hint"><?php echo \think\Lang::get('member_qqconnect_binding_click'); ?></p>
    </div>
    <div class="revise pt50">
        <p class="qq"><?php echo \think\Lang::get('member_qqconnect_binding_goodtip_1'); ?></p>
        <p><?php echo \think\Lang::get('member_qqconnect_binding_goodtip_2'); ?></p>
        <p class="hint"><?php echo \think\Lang::get('member_qqconnect_binding_goodtip_3'); ?></p>
    </div>
    <?php endif; ?>
</div>
<?php else: ?>
<div class="warning-option"><i>&nbsp;</i><span><?php echo \think\Lang::get('member_qqconnect_unavailable'); ?></span></div>
<?php endif; ?>
...
$(function(){
    ...
    $('#editpw_form').validate({
        ...
        messages : {
            new_password  : {
                required   : "<i class='iconfont'>&#xe64c;</i><?php echo \think\Lang::get('member_qqconnect_new_password_null'); ?>",
                minlength  : "<i class='iconfont'>&#xe64c;</i><?php echo \think\Lang::get('member_qqconnect_password_range'); ?>"
            },
            confirm_password : {
                required   : "<i class='iconfont'>&#xe64c;</i><?php echo \think\Lang::get('member_qqconnect_ensure_password_null'); ?>",
                equalTo    : "<i class='iconfont'>&#xe64c;</i><?php echo \think\Lang::get('member_qqconnect_input_two_password_again'); ?>"
            }
        }
    });
});
...
<div class="server">
    ...
    <div class="mall_desc">
        <?php if(!(empty($article_list) || (($article_list instanceof \think\Collection || $article_list instanceof \think\Paginator ) && $article_list->isEmpty()))): if(is_array($article_list) || $article_list instanceof \think\Collection || $article_list instanceof \think\Paginator): $_5e9534131e5af = is_array($article_list) ? array_slice($article_list,0,4, true) : $article_list->slice(0,4, true); if( count($_5e9534131e5af)==0 ) : echo "" ;else: foreach($_5e9534131e5af as $key=>$art): ?>
        <dl> 
