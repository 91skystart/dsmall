...
<?php endif; ?>
 ...
 <form method="get">
            <table class="search-form">
                <tr>
                    <td>&nbsp;</td>
                    <th><?php echo \think\Lang::get('cost_consumption_content'); ?></th>
                    <td class="w160"><input type="text" class="text w150" name="storecost_remark" value="<?php echo \think\Request::instance()->param('storecost_remark'); ?>" /></td>
                    <th><?php echo \think\Lang::get('cost_time'); ?></th>
                    <td class="w240">
        ...
        <table class="dssc-default-table">
            <thead>
                <tr>
                    <th class="w120"><?php echo \think\Lang::get('cost_consumption_amount'); ?></th>
                    <th class="tl"><?php echo \think\Lang::get('cost_consumption_content'); ?></th>
                    <th class="w80"><?php echo \think\Lang::get('cost_status'); ?></th>
                    <th class="w130"><?php echo \think\Lang::get('cost_time'); ?></th>
                </tr>
            </thead>
            <tbody>
                <?php if(!(empty($cost_list) || (($cost_list instanceof \think\Collection || $cost_list instanceof \think\Paginator ) && $cost_list->isEmpty()))): if(is_array($cost_list) || $cost_list instanceof \think\Collection || $cost_list instanceof \think\Paginator): if( count($cost_list)==0 ) : echo "" ;else: foreach($cost_list as $key=>$value): ?>
                <tr class="bd-line">
                    <td><?php echo $value['storecost_price']; ?></td>
                    <td class="tl"><?php echo $value['storecost_remark']; ?></td>
                    <td><?php if($value['storecost_state']): ?><?php echo \think\Lang::get('cost_settled'); else: ?><?php echo \think\Lang::get('cost_not_settled'); endif; ?></td>
                    <td><?php echo date("Y-m-d H:s",$value['storecost_time']); ?></td>
                </tr>
