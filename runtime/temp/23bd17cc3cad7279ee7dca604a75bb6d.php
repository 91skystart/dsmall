...
<table class="dsm-default-table">
            ...
            <tr>
                <th class="w30"></th>
                <th class="w100 tl">
                    <?php if($drop_type == 'msg_seller'): ?>
                    <?php echo \think\Lang::get('home_message_storename'); else: ?>
                    <?php echo \think\Lang::get('home_message_sender'); endif; ?>
                   </th>
                <th class="tl"><?php echo \think\Lang::get('home_message_content'); ?></th>
                <th class="w300"><?php echo \think\Lang::get('home_message_last_update'); ?></th>
                <th class="w110"><?php echo \think\Lang::get('home_message_command'); ?></th>
            </tr>
            <?php if(!(empty($message_array) || (($message_array instanceof \think\Collection || $message_array instanceof \think\Paginator ) && $message_array->isEmpty()))): ?>
            <tr>
                <td colspan="20"><input type="checkbox" id="all" class="checkall"/>
                    <label for="all"><?php echo \think\Lang::get('home_message_select_all'); ?></label>
                    <?php if($drop_type == 'msg_list'): ?>
                    <a href="javascript:void(0)" class="dsm-btn-mini" uri="<?php echo url('Membermessage/dropcommonmsg',['drop_type'=>$drop_type]); ?>" name="message_id" confirm="<?php echo \think\Lang::get('home_message_delete_confirm'); ?>?" ds_type="batchbutton"><i class="iconfont">&#xe725;</i><?php echo \think\Lang::get('home_message_delete'); ?></a>
                    <?php endif; if($drop_type == 'msg_system' || $drop_type == 'msg_seller'): ?>
                    <a href="javascript:void(0)" class="dsm-btn-mini" uri="<?php echo url('Membermessage/dropbatchmsg',['drop_type'=>$drop_type]); ?>" name="message_id" confirm="<?php echo \think\Lang::get('home_message_delete_confirm'); ?>?" ds_type="batchbutton"><?php echo \think\Lang::get('home_message_delete'); ?></a>
                    <?php endif; ?>
                    </td>
            </tr>
            <?php endif; ?>
            ...
            <tbody>
            <?php if(!(empty($message_array) || (($message_array instanceof \think\Collection || $message_array instanceof \think\Paginator ) && $message_array->isEmpty()))): if(is_array($message_array) || $message_array instanceof \think\Collection || $message_array instanceof \think\Paginator): if( count($message_array)==0 ) : echo "" ;else: foreach($message_array as $key=>$v): ?>
            <tr class="bd-line">
                <td class="tc"><input type="checkbox" class="checkitem" value="<?php echo $v['message_id']; ?>"/></td>
                <td class="tl"><?php echo $v['from_member_name']; ?></td>
                <td class="link2 <?php if($v['message_open'] == 0): ?>font_bold<?php endif; ?> tl"><?php echo parsesmiles($v['message_body']); ?></td>
                <td><?php echo date('Y-m-d H:i:s',$v['message_update_time']); ?></td>
                <td class="dsm-table-handle">
                    <?php if($drop_type == 'msg_list'): ?>
                    <span><a href="<?php echo url('Membermessage/showmsgcommon',['type'=>$drop_type,'message_id'=>$v['message_id']]); if($v['message_parent_id']>0): ?>#<?php echo $v['message_id']; endif; ?>" class="btn-blue"><i class="iconfont">&#xe731;</i>
          <p><?php echo \think\Lang::get('home_message_view_detail'); ?></p>
          </a></span> <span><a href="javascript:void(0)" onclick="ds_ajaxget_confirm('<?php echo url('Membermessage/dropcommonmsg',['drop_type'=>$drop_type,'message_id'=>$v['message_id']]); ?>','<?php echo \think\Lang::get('home_message_delete_confirm'); ?>?');" class="btn-red"><i class="iconfont">&#xe725;</i>
          <p><?php echo \think\Lang::get('home_message_delete'); ?></p>
          </a></span>
                    <?php endif; if($drop_type=='msg_system' || $drop_type =='msg_seller'): ?>
                    <span><a href="<?php echo url('Membermessage/showmsgbatch',['type'=>$drop_type,'message_id'=>$v['message_id']]); if($v['message_parent_id']>0): ?>#<?php echo $v['message_id']; endif; ?>" class="btn-acidblue"><i class="iconfont">&#xe70b;</i>
          <p><?php echo \think\Lang::get('home_message_view_detail'); ?></p>
          </a></span><span><a href="javascript:void(0)" onclick="ds_ajaxget_confirm('<?php echo url('Membermessage/dropbatchmsg',['drop_type'=>$drop_type,'message_id'=>$v['message_id']]); ?>','<?php echo \think\Lang::get('home_message_delete_confirm'); ?>?');" class="btn-red"><i class="iconfont">&#xe725;</i>
          <p><?php echo \think\Lang::get('home_message_delete'); ?></p>
          </a></span>
                    <?php endif; ?></td>
            </tr>
...
<div class="server">
    ...
    <div class="mall_desc">
        <?php if(!(empty($article_list) || (($article_list instanceof \think\Collection || $article_list instanceof \think\Paginator ) && $article_list->isEmpty()))): if(is_array($article_list) || $article_list instanceof \think\Collection || $article_list instanceof \think\Paginator): $_5e952c30d401e = is_array($article_list) ? array_slice($article_list,0,4, true) : $article_list->slice(0,4, true); if( count($_5e952c30d401e)==0 ) : echo "" ;else: foreach($_5e952c30d401e as $key=>$art): ?>
        <dl> 
