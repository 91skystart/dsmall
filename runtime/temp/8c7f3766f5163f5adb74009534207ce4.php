<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:83:"/usr/local/var/www/dsmall/public/../application/admin/view/goodsalbum/pic_list.html";i:1574757822;s:67:"/usr/local/var/www/dsmall/application/admin/view/public/header.html";i:1574757822;s:72:"/usr/local/var/www/dsmall/application/admin/view/public/admin_items.html";i:1574757822;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<div class="page">
    <div class="fixed-bar">
        <div class="item-title">
            <div class="subject">
                <h3><?php echo \think\Lang::get('ds_album'); ?></h3>
                <h5></h5>
            </div>
            <?php if($admin_item): ?>
                            ...
                            <div class="size-64x64">
                                <span class="thumb">
                                    ...
                                    <a data-lightbox="lightbox-image" href="<?php echo goods_cthumb($v['apic_cover'],1280,$v['store_id']); ?>" rel="gal">
                                        <img title='<?php echo date("Y-m-d",$v['apic_uploadtime']); ?><br><?php echo $v['apic_spec']; ?>px<br><?php echo number_format($v['apic_size']/1024,2); ?>k' width="64" height="64" class="tip" src="<?php echo goods_cthumb($v['apic_cover'],240,$v['store_id']); ?>">
                                    </a>
                                    <?php else: ?>
