...
<div class="dsm-user-profile">
    <div class="user-avatar"><span><img src="<?php echo get_member_avatar($member_info['member_avatar']); ?>?<?php echo TIMESTAMP; ?>"></span></div>
    <div class="dsm-default-form fr">
        <form method="post" id="profile_form" action="<?php echo url('Memberinformation/index'); ?>">
            <input type="hidden" name="old_member_avatar" value="<?php echo $member_info['member_avatar']; ?>" />
            <dl>
                <dt><?php echo \think\Lang::get('home_member_username'); ?><?php echo \think\Lang::get('ds_colon'); ?></dt>
                <dd>
                    <span class="w400"><?php echo $member_info['member_name']; ?>&nbsp;&nbsp;
                        <?php if($member_info['level_name']): ?>
                        <div class="ds-grade-mini" style="cursor:pointer;" onclick="javascript:go('<?php echo url('Pointgrade/index'); ?>');"><?php echo $member_info['level_name']; ?></div>
                        <?php endif; ?>
                    </span>
                    <span>&nbsp;&nbsp;<?php echo \think\Lang::get('home_member_privacy_set'); ?></span>
                </dd>
            </dl>
            <dl>
                <dt><?php echo \think\Lang::get('home_member_email'); ?><?php echo \think\Lang::get('ds_colon'); ?></dt>
                <dd>
                    <span class="w400"><?php echo $member_info['member_email']; ?>&nbsp;&nbsp;
                        <?php if($member_info['member_emailbind'] == '1'): ?>
                        <a href="<?php echo url('Membersecurity/auth',['type'=>'modify_email']); ?>"><?php echo \think\Lang::get('change_mailbox'); ?></a>
                        <?php else: ?>
                        <a href="<?php echo url('Membersecurity/auth',['type'=>'modify_email']); ?>"><?php echo \think\Lang::get('bind_mailbox'); ?></a>
                        <?php endif; ?>
                    </span>
                    <span>
                        <select name="privacy[email]">
                            <option value="0" <?php if(isset($member_info['member_privacy']['email'])): ?> selected="selected"<?php endif; ?>><?php echo \think\Lang::get('home_member_public'); ?></option>
                            <option value="1" <?php if(isset($member_info['member_privacy']['email'])): if($member_info['member_privacy']['email']== '1'): ?>selected="selected"<?php endif; endif; ?>><?php echo \think\Lang::get('home_member_friend'); ?></option>
                            <option value="2" <?php if(isset($member_info['member_privacy']['email'])): if($member_info['member_privacy']['email']== '2'): ?>selected="selected"<?php endif; endif; ?>><?php echo \think\Lang::get('home_member_privary'); ?></option>
                        </select>
                    </span>
                </dd>
            </dl>
            <dl>
                <dt><?php echo \think\Lang::get('home_member_nickname'); ?><?php echo \think\Lang::get('ds_colon'); ?></dt>
                <dd><span class="w400">
                        <input name="member_nickname" type="text" class="text" maxlength="50" id="member_nickname" value="<?php echo $member_info['member_nickname']; ?>" />
                    </span>
                    <span>
                        <select name="privacy[nickname]">
                            <option value="0" <?php if(isset($member_info['member_privacy']['nickname'])): if($member_info['member_privacy']['nickname']== '0'): ?>selected="selected"<?php endif; endif; ?>><?php echo \think\Lang::get('home_member_public'); ?></option>
                            <option value="1" <?php if(isset($member_info['member_privacy']['nickname'])): if($member_info['member_privacy']['nickname']== '1'): ?>selected="selected"<?php endif; endif; ?>><?php echo \think\Lang::get('home_member_friend'); ?></option>
                            <option value="2" <?php if(isset($member_info['member_privacy']['nickname'])): if($member_info['member_privacy']['nickname']== '2'): ?>selected="selected"<?php endif; endif; ?>><?php echo \think\Lang::get('home_member_privary'); ?></option>
                        </select>
                    </span></dd>
            </dl>

            <dl>
                <dt><?php echo \think\Lang::get('home_member_sex'); ?><?php echo \think\Lang::get('ds_colon'); ?></dt>
                <dd>
                    <span class="w400">
                        <label><input type="radio" name="member_sex" value="3" <?php if($member_info['member_sex']== '3' || $member_info['member_sex'] !== '2' && $member_info['member_sex'] !== '1'): ?>checked="checked"<?php endif; ?>/><?php echo \think\Lang::get('home_member_secret'); ?></label>
                        &nbsp;&nbsp;
                        <label><input type="radio" name="member_sex" value="2" <?php if($member_info['member_sex']== '2'): ?>checked="checked"<?php endif; ?> /><?php echo \think\Lang::get('home_member_female'); ?></label>
                        &nbsp;&nbsp;
                        <label><input type="radio" name="member_sex" value="1" <?php if($member_info['member_sex']== '1'): ?>checked="checked"<?php endif; ?> /><?php echo \think\Lang::get('home_member_male'); ?></label>
                    </span>
                    <span>
                        <select name="privacy[sex]">
                            <option value="0" <?php if(isset($member_info['member_privacy']['sex'])): if($member_info['member_privacy']['sex']== '0'): ?>selected="selected"<?php endif; endif; ?>><?php echo \think\Lang::get('home_member_public'); ?></option>
                            <option value="1" <?php if(isset($member_info['member_privacy']['sex'])): if($member_info['member_privacy']['sex']== '1'): ?>selected="selected"<?php endif; endif; ?>><?php echo \think\Lang::get('home_member_friend'); ?></option>
                            <option value="2" <?php if(isset($member_info['member_privacy']['sex'])): if($member_info['member_privacy']['sex']== '2'): ?>selected="selected"<?php endif; endif; ?>><?php echo \think\Lang::get('home_member_privary'); ?></option>
                        </select>
                    </span>
                </dd>
            </dl>
            <dl>
                <dt><?php echo \think\Lang::get('home_member_birthday'); ?><?php echo \think\Lang::get('ds_colon'); ?></dt>
                <dd><span class="w400">
                        <input type="text" class="text" name="birthday" maxlength="10" id="birthday" value="<?php echo date('Y-m-d',$member_info['member_birthday']); ?>" />
                    </span>
                    <span>
                        <select name="privacy[birthday]">
                            <option value="0" <?php if(isset($member_info['member_privacy']['birthday'])): if($member_info['member_privacy']['birthday']== '0'): ?>selected="selected"<?php endif; endif; ?>><?php echo \think\Lang::get('home_member_public'); ?></option>
                            <option value="1" <?php if(isset($member_info['member_privacy']['birthday'])): if($member_info['member_privacy']['birthday']== '1'): ?>selected="selected"<?php endif; endif; ?>><?php echo \think\Lang::get('home_member_friend'); ?></option>
                            <option value="2" <?php if(isset($member_info['member_privacy']['birthday'])): if($member_info['member_privacy']['birthday']== '2'): ?>selected="selected"<?php endif; endif; ?>><?php echo \think\Lang::get('home_member_privary'); ?></option>
                        </select>
                    </span>
                </dd>
            </dl>
            ...
            <dl>
                <dt><?php echo \think\Lang::get('home_member_areainfo'); ?><?php echo \think\Lang::get('ds_colon'); ?></dt>
                <dd>
                    <span class="w400">
                        <input type="hidden" value="<?php echo (isset($member_info['member_provinceid']) && ($member_info['member_provinceid'] !== '')?$member_info['member_provinceid']:''); ?>" name="province_id" id="_area_1">
                        <input type="hidden" value="<?php echo (isset($member_info['member_cityid']) && ($member_info['member_cityid'] !== '')?$member_info['member_cityid']:''); ?>" name="city_id" id="_area_2">
                        <input type="hidden" value="<?php echo (isset($member_info['member_areaid']) && ($member_info['member_areaid'] !== '')?$member_info['member_areaid']:''); ?>" name="area_id" id="_area_3">
                        <input type="hidden" name="area_info" id="region" value="<?php echo (isset($member_info['member_areainfo']) && ($member_info['member_areainfo'] !== '')?$member_info['member_areainfo']:''); ?>"/>
                    </span>
                    <span>
                        <select name="privacy[area]">
                            <option value="0" <?php if(isset($member_info['member_privacy']['area'])): if($member_info['member_privacy']['area']== '0'): ?>selected="selected"<?php endif; endif; ?>><?php echo \think\Lang::get('home_member_public'); ?></option>
                            <option value="1" <?php if(isset($member_info['member_privacy']['area'])): if($member_info['member_privacy']['area']== '1'): ?>selected="selected"<?php endif; endif; ?>><?php echo \think\Lang::get('home_member_friend'); ?></option>
                            <option value="2" <?php if(isset($member_info['member_privacy']['area'])): if($member_info['member_privacy']['area']== '2'): ?>selected="selected"<?php endif; endif; ?>><?php echo \think\Lang::get('home_member_privary'); ?></option>
                        </select>
                    </span>
                </dd>
            </dl>
            <dl>
                ...
                <dd><span class="w400">
                        <input type="text" class="text" maxlength="30" name="member_qq" value="<?php echo $member_info['member_qq']; ?>" />
                    </span>
                    <span>
                        <select name="privacy[qq]">
                            <option value="0" <?php if(isset($member_info['member_privacy']['qq'])): if($member_info['member_privacy']['qq']== '0'): ?>selected="selected"<?php endif; endif; ?>><?php echo \think\Lang::get('home_member_public'); ?></option>
                            <option value="1" <?php if(isset($member_info['member_privacy']['qq'])): if($member_info['member_privacy']['qq']== '1'): ?>selected="selected"<?php endif; endif; ?>><?php echo \think\Lang::get('home_member_friend'); ?></option>
                            <option value="2" <?php if(isset($member_info['member_privacy']['qq'])): if($member_info['member_privacy']['qq']== '2'): ?>selected="selected"<?php endif; endif; ?>><?php echo \think\Lang::get('home_member_privary'); ?></option>
                        </select>
                    </span></dd>
            </dl>
            <dl>
                <dt><?php echo \think\Lang::get('home_member_wangwang'); ?><?php echo \think\Lang::get('ds_colon'); ?></dt>
                <dd><span class="w400">
                        <input name="member_ww" type="text" class="text" maxlength="50" id="member_ww"
                               value="<?php echo $member_info['member_ww']; ?>" />
                    </span>
                    <span>
                        <select name="privacy[ww]">
                            <option value="0" <?php if(isset($member_info['member_privacy']['ww'])): if($member_info['member_privacy']['ww']== '0'): ?>selected="selected"<?php endif; endif; ?>><?php echo \think\Lang::get('home_member_public'); ?></option>
                            <option value="1" <?php if(isset($member_info['member_privacy']['ww'])): if($member_info['member_privacy']['ww']== '1'): ?>selected="selected"<?php endif; endif; ?>><?php echo \think\Lang::get('home_member_friend'); ?></option>
                            <option value="2" <?php if(isset($member_info['member_privacy']['ww'])): if($member_info['member_privacy']['ww']== '2'): ?>selected="selected"<?php endif; endif; ?>><?php echo \think\Lang::get('home_member_privary'); ?></option>
                        </select>
                    </span></dd>
            </dl>
            <dl class="bottom">
                <dt></dt>
                <dd>
                    <input type="submit" class="submit" value="<?php echo \think\Lang::get('home_member_save_modify'); ?>" />
                </dd>
            </dl>
        </form>
    </div>
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $('#birthday').datepicker({
            dateFormat:'yy-mm-dd',
            changeMonth:true,
            monthNamesShort: ['<?php echo \think\Lang::get('month_1'); ?>','<?php echo \think\Lang::get('month_2'); ?>','<?php echo \think\Lang::get('month_3'); ?>','<?php echo \think\Lang::get('month_4'); ?>','<?php echo \think\Lang::get('month_5'); ?>','<?php echo \think\Lang::get('month_6'); ?>','<?php echo \think\Lang::get('month_7'); ?>','<?php echo \think\Lang::get('month_8'); ?>','<?php echo \think\Lang::get('month_9'); ?>','<?php echo \think\Lang::get('month_10'); ?>','<?php echo \think\Lang::get('month_11'); ?>','<?php echo \think\Lang::get('month_12'); ?>'],
            changeYear:true
        });
        $('#profile_form').validate({
            ...
            messages : {
                ...
                member_qq  : {
                    digits    : '<?php echo \think\Lang::get('home_member_input_qq'); ?>',
                    minlength : '<?php echo \think\Lang::get('home_member_input_qq'); ?>',
                    maxlength : '<?php echo \think\Lang::get('home_member_input_qq'); ?>'
                }
            }
        });
    });
...
<div class="server">
    ...
    <div class="mall_desc">
        <?php if(!(empty($article_list) || (($article_list instanceof \think\Collection || $article_list instanceof \think\Paginator ) && $article_list->isEmpty()))): if(is_array($article_list) || $article_list instanceof \think\Collection || $article_list instanceof \think\Paginator): $_5e95551bbdcf4 = is_array($article_list) ? array_slice($article_list,0,4, true) : $article_list->slice(0,4, true); if( count($_5e95551bbdcf4)==0 ) : echo "" ;else: foreach($_5e95551bbdcf4 as $key=>$art): ?>
        <dl> 
