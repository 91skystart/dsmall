...
<?php endif; if($isallowsend): ?>
            <a href="<?php echo url('Membermessage/sendmsg'); ?>" class="dsm-btn dsm-btn-orange" title="<?php echo \think\Lang::get('home_message_send_message'); ?>"><i class="iconfont">&#xe75a;</i><?php echo \think\Lang::get('home_message_send_message'); ?></a>
            <?php endif; ?>
...
<div class="dsm-message-setting">
    <form method="post" action="<?php echo url('Membermessage/setting'); ?>" id="setting_form">
        <dl>
            <dt><span><i class="iconfont">&#xe69a;</i></span><?php echo \think\Lang::get('order_transaction_notification'); ?></dt>
            <dd>
                <ul>
                    <li>
                        <input type="checkbox" name="order_payment_success" id="order_payment_success" value="1" <?php if($setting_array['order_payment_success']): ?>checked<?php endif; ?> />
                               <label for="order_payment_success"><?php echo \think\Lang::get('payment_success_prompt'); ?></label></li>
                    <li>
                        <input type="checkbox" name="order_deliver_success" id="order_deliver_success" value="1" <?php if($setting_array['order_deliver_success']): ?>checked<?php endif; ?> />
                               <label for="order_deliver_success"><?php echo \think\Lang::get('goods_delivery_prompt'); ?></label></li>
                    <li>
                        <input type="checkbox" name="vr_code_will_expire" id="vr_code_will_expire" value="1" <?php if($setting_array['vr_code_will_expire']): ?>checked<?php endif; ?> />
                               <label for="vr_code_will_expire"><?php echo \think\Lang::get('reminder_redemption_code_expire'); ?></label></li>
                </ul>
            </dd>
        </dl>
        <dl>
            <dt><span><i class="iconfont">&#xe6a1;</i></span><?php echo \think\Lang::get('reminder_balance_card'); ?></dt>
            <dd>
                <ul>
                    <li>
                        <input type="checkbox" name="predeposit_change" id="predeposit_change" value="1" <?php if($setting_array['predeposit_change']): ?>checked<?php endif; ?> />
                               <label for="predeposit_change"><?php echo \think\Lang::get('balance_change_reminder'); ?></label></li>
                    <li>
                        <input type="checkbox" name="recharge_card_balance_change" id="recharge_card_balance_change" value="1" <?php if($setting_array['recharge_card_balance_change']): ?>checked<?php endif; ?> />
                               <label for="recharge_card_balance_change"><?php echo \think\Lang::get('recharge_card_balance_reminder'); ?></label></li>
                    <li>
                        <input type="checkbox" name="voucher_use" id="voucher_use" value="1" <?php if($setting_array['voucher_use']): ?>checked<?php endif; ?> />
                               <label for="voucher_use"><?php echo \think\Lang::get('voucher_use_reminder'); ?></label></li>
                    <li>
                        <input type="checkbox" name="voucher_will_expire" id="voucher_will_expire" value="1" <?php if($setting_array['voucher_will_expire']): ?>checked<?php endif; ?> />
                               <label for="voucher_will_expire"><?php echo \think\Lang::get('voucher_about_expire'); ?></label></li>
                </ul>
            </dd>
        </dl>
        <dl>
            <dt><span><i class="iconfont">&#xe615;</i></span><?php echo \think\Lang::get('service_message'); ?></dt>
            <dd>
                <ul>
                    <li>
                        <input type="checkbox" name="refund_return_notice" id="refund_return_notice" value="1" <?php if($setting_array['refund_return_notice']): ?>checked<?php endif; ?> />
                               <label for="refund_return_notice"><?php echo \think\Lang::get('return_service_messageexchange_message'); ?></label></li>
                    <li>
                        <input type="checkbox" name="arrival_notice" id="arrival_notice" value="1" <?php if($setting_array['arrival_notice']): ?>checked<?php endif; ?> />
                               <label for="arrival_notice"><?php echo \think\Lang::get('arrival_notification_message'); ?></label></li>
                    <li>
                        <input type="checkbox" name="consult_goods_reply" id="consult_goods_reply" value="1" <?php if($setting_array['consult_goods_reply']): ?>checked<?php endif; ?> />
                               <label for="consult_goods_reply"><?php echo \think\Lang::get('prompt_consultation_reply'); ?></label></li>
                    <li>
                        <input type="checkbox" name="consult_mall_reply" id="consult_mall_reply" value="1" <?php if($setting_array['consult_mall_reply']): ?>checked<?php endif; ?> />
                               <label for="consult_mall_reply"><?php echo \think\Lang::get('platform_consultation_response_prompt'); ?></label></li>
                </ul>
            </dd>
        </dl>
        <div class="bottom tc">
            <input id="btn_inform_submit" type="submit" class="submit" value="<?php echo \think\Lang::get('ds_submit'); ?>" />
        </div>
    </form>
</div>
<script>
...
<div class="server">
    ...
    <div class="mall_desc">
        <?php if(!(empty($article_list) || (($article_list instanceof \think\Collection || $article_list instanceof \think\Paginator ) && $article_list->isEmpty()))): if(is_array($article_list) || $article_list instanceof \think\Collection || $article_list instanceof \think\Paginator): $_5e952c3576fc6 = is_array($article_list) ? array_slice($article_list,0,4, true) : $article_list->slice(0,4, true); if( count($_5e952c3576fc6)==0 ) : echo "" ;else: foreach($_5e952c3576fc6 as $key=>$art): ?>
        <dl> 
