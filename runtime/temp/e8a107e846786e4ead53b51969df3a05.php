<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:89:"/usr/local/var/www/dsmall/public/../application/home/view/default/base/dispatch_jump.html";i:1574757822;s:74:"/usr/local/var/www/dsmall/application/home/view/default/base/mall_top.html";i:1574757822;s:77:"/usr/local/var/www/dsmall/application/home/view/default/base/mall_header.html";i:1574757822;s:77:"/usr/local/var/www/dsmall/application/home/view/default/base/mall_server.html";i:1574757822;s:77:"/usr/local/var/www/dsmall/application/home/view/default/base/mall_footer.html";i:1574757822;}*/ ?>
<!doctype html>
<html>
    <head>
...
<style type="text/css">
    ...
    .system-message i{float: left;padding-right: 10px;width: 41px;height: 40px;background: url(<?php echo HOME_SITE_ROOT; ?>/images/pw-icon.gif) no-repeat;}
...
<div class="w1200">
    <div class="system-message">
        ...
        <p class="detail"></p>
        <p class="jump">
            <?php echo \think\Lang::get('page_automatic'); ?> <a id="href" href="<?php echo($url);?>"><?php echo \think\Lang::get('jump'); ?></a> <?php echo \think\Lang::get('waiting_time'); ?>： <b id="wait"><?php echo($wait);?></b>
        </p>
    </div>
</div>
    <script type="text/javascript">
...
<div class="server">
    ...
    <div class="mall_desc">
        <?php if(!(empty($article_list) || (($article_list instanceof \think\Collection || $article_list instanceof \think\Paginator ) && $article_list->isEmpty()))): if(is_array($article_list) || $article_list instanceof \think\Collection || $article_list instanceof \think\Paginator): $_5e9534f5df88d = is_array($article_list) ? array_slice($article_list,0,4, true) : $article_list->slice(0,4, true); if( count($_5e9534f5df88d)==0 ) : echo "" ;else: foreach($_5e9534f5df88d as $key=>$art): ?>
        <dl> 
