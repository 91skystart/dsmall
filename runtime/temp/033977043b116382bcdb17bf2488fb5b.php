...
<table class="dsm-default-table">
            ...
            <tr>
                <th class="w30"></th>
                <th class="w100 tl"><?php echo \think\Lang::get('home_message_recipient'); ?></th>
            ...
            <tr>
                <td colspan="20"><input type="checkbox" id="all" class="checkall"/>
                    ...
                    <a href="javascript:void(0)" class="dsm-btn-mini" uri="<?php echo url('Membermessage/dropcommonmsg',['drop_type'=>$drop_type]); ?>" name="message_id" confirm="<?php echo \think\Lang::get('home_message_delete_confirm'); ?>?" ds_type="batchbutton"><i class="iconfont">&#xe725;</i><?php echo \think\Lang::get('home_message_delete'); ?></a></td>
            </tr>
           <?php endif; ?>
            </thead>
            <tbody>
            ...
            <tr class="bd-line">
                ...
                <td class="dsm-table-handle"><span><a href="javascript:void(0)" onclick="ds_ajaxget_confirm('<?php echo url('Membermessage/dropcommonmsg',['drop_type'=>$drop_type,'message_id'=>$v['message_id']]); ?>','<?php echo \think\Lang::get('home_message_delete_confirm'); ?>?');" class="btn-red"><i class="iconfont">&#xe725;</i>
...
<div class="server">
    ...
    <div class="mall_desc">
        <?php if(!(empty($article_list) || (($article_list instanceof \think\Collection || $article_list instanceof \think\Paginator ) && $article_list->isEmpty()))): if(is_array($article_list) || $article_list instanceof \think\Collection || $article_list instanceof \think\Paginator): $_5e952c32bf82a = is_array($article_list) ? array_slice($article_list,0,4, true) : $article_list->slice(0,4, true); if( count($_5e952c32bf82a)==0 ) : echo "" ;else: foreach($_5e952c32bf82a as $key=>$art): ?>
        <dl> 
