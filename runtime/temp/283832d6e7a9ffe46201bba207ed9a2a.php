...
<form method="get" action="">
    <table class="dsm-search-table">
        <tr>
            ...
            <td class="w240">
                <input name="add_time_from" id="add_time_from" type="text" class="text w70" value="<?php echo \think\Request::instance()->param('add_time_from'); ?>" /><label class="add-on"><i class="iconfont">&#xe8d6;</i></label>
                &nbsp;&#8211;&nbsp;
                <input name="add_time_to" id="add_time_to" type="text" class="text w70" value="<?php echo \think\Request::instance()->param('add_time_to'); ?>" /><label class="add-on"><i class="iconfont">&#xe8d6;</i></label>
            </td>
            <th><select name="type">
                    <option value="order_sn" <?php if(\think\Request::instance()->param('type') == 'order_sn'): ?>selected<?php endif; ?>><?php echo \think\Lang::get('refund_order_ordersn'); ?></option>
                    <option value="refund_sn" <?php if(\think\Request::instance()->param('type') == 'refund_sn'): ?>selected<?php endif; ?>><?php echo \think\Lang::get('refund_order_refundsn'); ?></option>
...
<table class="dsm-default-table order">
    ...
    <tbody>
        ...
        <tr>
            <th colspan="20"> <span class="ml10"><?php echo \think\Lang::get('refund_order_refundsn'); ?><?php echo \think\Lang::get('ds_colon'); ?></span><span><?php echo \think\Lang::get('refund_buyer_add_time'); ?><?php echo \think\Lang::get('ds_colon'); ?><?php echo date("Y-m-d H:i:s",$val['add_time']); ?></span>

                <!-- store_name -->
                <span> <a href="<?php echo url('Store/index',['store_id'=>$val['store_id']]); ?>" target="_blank" title="<?php echo $val['store_name']; ?>"><?php echo $val['store_name']; ?></a></span>
        ...
        <tr class="bd-line" >
            ...
            <td><?php if($val['seller_state']==2): ?><?php echo $admin_array[$val['refund_state']]; else: ?><?php echo \think\Lang::get('none'); endif; ?></td>
            <td class="bdr"><a href="<?php echo url('Memberrefund/view',['refund_id'=>$val['refund_id']]); ?>" class="dsm-btn"><?php echo \think\Lang::get('ds_view'); ?> </a></td>
        </tr>
        <?php endforeach; endif; else: echo "" ;endif; ?>
    </tbody>
    <tfoot>
...
<div class="server">
    ...
    <div class="mall_desc">
        <?php if(!(empty($article_list) || (($article_list instanceof \think\Collection || $article_list instanceof \think\Paginator ) && $article_list->isEmpty()))): if(is_array($article_list) || $article_list instanceof \think\Collection || $article_list instanceof \think\Paginator): $_5e95575cddeda = is_array($article_list) ? array_slice($article_list,0,4, true) : $article_list->slice(0,4, true); if( count($_5e95575cddeda)==0 ) : echo "" ;else: foreach($_5e95575cddeda as $key=>$art): ?>
        <dl> 
