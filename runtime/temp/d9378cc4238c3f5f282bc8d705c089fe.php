...
<div class="dsm-default-form member_auth">
    <form method="post" action="" id="member_form" enctype="multipart/form-data">
        ...
        <dl>
            <dt><?php echo \think\Lang::get('member_truename'); ?>：</dt>
            <dd>
                <span class="w400">
                    <input type="text" class="text" maxlength="20" name="member_truename" value="<?php echo $member_info['member_truename']; ?>" <?php if(in_array($member_info['member_auth_state'],array(1,3))): ?>disabled=""<?php endif; ?>>
                </span>
            </dd>
        </dl>
        <dl>
            <dt><?php echo \think\Lang::get('member_idcard'); ?>：</dt>
            <dd>
                <span class="w400">
                    <input type="text" class="text" maxlength="20" name="member_idcard" value="<?php echo $member_info['member_idcard']; ?>" <?php if(in_array($member_info['member_auth_state'],array(1,3))): ?>disabled=""<?php endif; ?>>
                </span>
            </dd>
        </dl>
        <dl>
            <dt><?php echo \think\Lang::get('member_idcard_image1'); ?>：</dt>
            <dd>
                <div>
                    <div class='image-wrapper'>
                    <div class="dssc-upload-thumb">
                        <p>
                            <img onclick='openPhoto("img_member_idcard_image1_url")' src="<?php if($member_info['member_idcard_image1']!=''): ?><?php echo get_member_idcard_image($member_info['member_idcard_image1']); else: ?><?php echo BASE_SITE_ROOT; ?>/static/home/images/member_idcard_image1.png<?php endif; ?>" id="img_member_idcard_image1_url" />
                        </p>
                        <?php if(!in_array($member_info['member_auth_state'],array(1,3))): ?><a href="javascript:dropImage('member_idcard_image1')" class="drop-btn iconfont">&#xe6e6;</a><?php endif; ?>
                    </div>
                    <?php if(!in_array($member_info['member_auth_state'],array(1,3))): ?>
                ...
                <span class="w400">
                    <input type="text" style="width:0;opacity: 0" name="member_idcard_image1" id="member_idcard_image1" value="<?php echo $member_info['member_idcard_image1']; ?>" <?php if(in_array($member_info['member_auth_state'],array(1,3))): ?>disabled=""<?php endif; ?>>
                </span>
            </dd>
        </dl>
        
        <dl>
            <dt><?php echo \think\Lang::get('member_idcard_image2'); ?>：</dt>
            <dd>
                <div>
                    <div class='image-wrapper'>
                    <div class="dssc-upload-thumb">
                        <p>
                            <img onclick='openPhoto("img_member_idcard_image2_url")' src="<?php if($member_info['member_idcard_image2']!=''): ?><?php echo get_member_idcard_image($member_info['member_idcard_image2']); else: ?><?php echo BASE_SITE_ROOT; ?>/static/home/images/member_idcard_image2.png<?php endif; ?>" id="img_member_idcard_image2_url" />
                        </p>
                        <?php if(!in_array($member_info['member_auth_state'],array(1,3))): ?><a href="javascript:dropImage('member_idcard_image2')" class="drop-btn iconfont">&#xe6e6;</a><?php endif; ?>
                    </div>
                    <?php if(!in_array($member_info['member_auth_state'],array(1,3))): ?>
                    <div class="dsm-upload-btn"> 
                        <a href="javascript:void(0);">
                ...
                <span class="w400">
                    <input type="text" style="width:0;opacity: 0" name="member_idcard_image2" id="member_idcard_image2" value="<?php echo $member_info['member_idcard_image2']; ?>" <?php if(in_array($member_info['member_auth_state'],array(1,3))): ?>disabled=""<?php endif; ?>>
                </span>
            </dd>
        </dl>
        ...
        <dl>
            <dt><?php echo \think\Lang::get('member_idcard_image3'); ?>：</dt>
            <dd>
                <div>
                    <div class='image-wrapper'>
                    <div class="dssc-upload-thumb">
                        <p>
                            <img onclick='openPhoto("img_member_idcard_image3_url")' src="<?php if($member_info['member_idcard_image3']!=''): ?><?php echo get_member_idcard_image($member_info['member_idcard_image3']); else: ?><?php echo BASE_SITE_ROOT; ?>/static/home/images/member_idcard_image3.png<?php endif; ?>" id="img_member_idcard_image3_url" />
                        </p>
                    <?php if(!in_array($member_info['member_auth_state'],array(1,3))): ?><a href="javascript:dropImage('member_idcard_image3')" class="drop-btn iconfont">&#xe6e6;</a><?php endif; ?>
                    </div>
                    <?php if(!in_array($member_info['member_auth_state'],array(1,3))): ?>
                    <div class="dsm-upload-btn"> 
                        <a href="javascript:void(0);">
                ...
                <span class="w400">
                    <input type="text" style="width:0;opacity: 0" name="member_idcard_image3" id="member_idcard_image3" value="<?php echo $member_info['member_idcard_image3']; ?>" <?php if(in_array($member_info['member_auth_state'],array(1,3))): ?>disabled=""<?php endif; ?>>
                </span>
            </dd>
        </dl>
        <?php if(!in_array($member_info['member_auth_state'],array(1,3))): ?>
...
function openPhoto(id){
    ...
    function dropImage(id){
        var index=layer.confirm("<?php echo \think\Lang::get('ds_ensure_del'); ?>", {
                btn: ['<?php echo \think\Lang::get('ds_ok'); ?>', '<?php echo \think\Lang::get('ds_cancel'); ?>'],
                title: false,
            }, function () {
                layer.close(index)
                $.getJSON('<?php echo url('MemberAuth/image_drop'); ?>',{file_name:id},function(res){
                    if(res.code!=10000){
                        layer.alert(res.message);
                    }else{
                        $('#'+id).val('')
                        $('#img_'+id+'_url').attr('src',"<?php echo BASE_SITE_ROOT; ?>/static/home/images/"+id+".png")
                    }
                })
            })
    }
    function ajaxFileUpload(url, id)
    {
        ...
        if($('#'+index).val()){
            layer.alert('<?php echo \think\Lang::get('please_drop_image'); ?>');
            return
        }
        $.ajaxFileUpload({
                url: url,
    ...
    $(document).ready(function () {
        var url = '<?php echo url("MemberAuth/image_upload"); ?>';
        ...
        $('#member_form').validate({
            submitHandler: function (form) {
                ds_ajaxpost('member_form','url','<?php echo url('MemberAuth/index'); ?>');
            },
            rules: {
                member_truename: {
                    required: true
            ...
            messages: {
                member_truename: {
                    required: '<?php echo \think\Lang::get('member_truename_require'); ?>'
                },
                member_idcard: {
                    required: '<?php echo \think\Lang::get('member_idcard_require'); ?>',
                },
                member_idcard_image1: {
                    required: '<?php echo \think\Lang::get('member_idcard_image1_require'); ?>',
                },
                member_idcard_image2: {
                    required: '<?php echo \think\Lang::get('member_idcard_image2_require'); ?>',
                },
                member_idcard_image3: {
                    required: '<?php echo \think\Lang::get('member_idcard_image3_require'); ?>',
                },
            }
        });
...
<div class="server">
    ...
    <div class="mall_desc">
        <?php if(!(empty($article_list) || (($article_list instanceof \think\Collection || $article_list instanceof \think\Paginator ) && $article_list->isEmpty()))): if(is_array($article_list) || $article_list instanceof \think\Collection || $article_list instanceof \think\Paginator): $_5e95584b9eecb = is_array($article_list) ? array_slice($article_list,0,4, true) : $article_list->slice(0,4, true); if( count($_5e95584b9eecb)==0 ) : echo "" ;else: foreach($_5e95584b9eecb as $key=>$art): ?>
        <dl> 
